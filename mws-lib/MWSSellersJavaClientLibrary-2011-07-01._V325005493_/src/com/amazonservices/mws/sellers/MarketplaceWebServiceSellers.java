...
public interface MarketplaceWebServiceSellers {
     ...
     * @throws MarketplaceWebServiceSellersException
     */
    ListMarketplaceParticipationsResponse listMarketplaceParticipations(
        ListMarketplaceParticipationsRequest request)
        throws MarketplaceWebServiceSellersException;
     ...
     * @throws MarketplaceWebServiceSellersException
     */
    ListMarketplaceParticipationsByNextTokenResponse listMarketplaceParticipationsByNextToken(
        ListMarketplaceParticipationsByNextTokenRequest request)
        throws MarketplaceWebServiceSellersException;
