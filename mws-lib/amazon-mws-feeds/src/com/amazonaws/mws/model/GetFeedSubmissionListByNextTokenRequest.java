 ...
 * 
 */
com.amazonaws.mws.model.GetFeedSubmissionListByNextTokenRequest [
@javax.xml.bind.annotation.XmlAccessorType(value=FIELD),
@javax.xml.bind.annotation.XmlType(name=, factoryClass=class javax.xml.bind.annotation.XmlType$DEFAULT,
        namespace=##default, factoryMethod=, propOrder=[marketplace, merchant, nextToken, mwsAuthToken]), @javax.xml.bind.annotation.XmlRootElement(name=GetFeedSubmissionListByNextTokenRequest, namespace=##default)]
