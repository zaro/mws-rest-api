...
public  class MarketplaceWebServiceClient implements MarketplaceWebService {
    ...
    static {
        try {
            jaxbContext = JAXBContext.newInstance("com.amazonaws.mws.products", MarketplaceWebService.class.getClassLoader());
    ...
    private static final String mwsClientLibraryVersion = "2014-09-30";
