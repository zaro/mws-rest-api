...
class MwsAQCall implements MwsCall {
    ...
    private HttpPost createRequest() {
        ...
        try {
            ...
            for(Entry<String, String> header : connection.getRequestHeaders().entrySet()) {
    ...
    private HttpResponse executeRequest(HttpPost request) throws Exception {
        try {
            ...
            httpClient.getConnectionManager().releaseConnection((ManagedClientConnection) httpClient, 60, TimeUnit.SECONDS);
