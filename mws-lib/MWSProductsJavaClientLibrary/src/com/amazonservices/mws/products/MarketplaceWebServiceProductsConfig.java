...
public class MarketplaceWebServiceProductsConfig {
    ...
    static final String DEFAULT_SERVICE_PATH = "Products/2011-10-01";
    ...
    public MarketplaceWebServiceProductsConfig withMaxConnections(int maxConnections) {
        cc.setMaxConnections(maxConnections);
        return this;
    }
    ...
    public MarketplaceWebServiceProductsConfig withServiceURL(String aserviceUrl) {
    ...
    public MarketplaceWebServiceProductsConfig withMaxAsyncQueueSize(int size) {
        cc.setMaxAsyncQueueSize(size);
        return this;
    }
    ...
    public MarketplaceWebServiceProductsConfig withMaxAsyncThreads(int threads) {
        cc.setMaxAsyncThreads(threads);
        return this;
    }
