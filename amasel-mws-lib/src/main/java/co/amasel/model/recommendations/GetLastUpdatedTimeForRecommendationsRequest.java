 ...
 * </pre>
 */
public class GetLastUpdatedTimeForRecommendationsRequest
		extends
			AmaselMwsObject {
	 ...
	 */
	public GetLastUpdatedTimeForRecommendationsRequest withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetLastUpdatedTimeForRecommendationsRequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLastUpdatedTimeForRecommendationsRequest withSellerId(
			String sellerId) {
		this.sellerId = sellerId;
		return this;
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Recommendations/2013-04-01",
				"GetLastUpdatedTimeForRecommendationsRequest", this);
	}

	/** Value constructor. */
	public GetLastUpdatedTimeForRecommendationsRequest(String marketplaceId,
