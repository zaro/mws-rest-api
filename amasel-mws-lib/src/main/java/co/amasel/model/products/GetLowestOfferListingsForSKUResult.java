...
@XmlType(name = "GetLowestOfferListingsForSKUResult", propOrder = {
		"allOfferListingsConsidered", "product", "error"})
@XmlRootElement(name = "GetLowestOfferListingsForSKUResult")
public class GetLowestOfferListingsForSKUResult extends AmaselMwsObject {
	...
	public boolean isAllOfferListingsConsidered() {
		return allOfferListingsConsidered != null
				&& allOfferListingsConsidered.booleanValue();
	}
	 ...
	 */
	public GetLowestOfferListingsForSKUResult withAllOfferListingsConsidered(
	...
	public void readFragmentFrom(MwsReader r) {
		...
		allOfferListingsConsidered = r.read("AllOfferListingsConsidered",
				Boolean.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestOfferListingsForSKUResult", this);
	}

	/** Value constructor. */
	public GetLowestOfferListingsForSKUResult(
			Boolean allOfferListingsConsidered, Product product, Error error,
			String sellerSKU, String status) {
		this.allOfferListingsConsidered = allOfferListingsConsidered;
		this.product = product;
		this.error = error;
		this.sellerSKU = sellerSKU;
