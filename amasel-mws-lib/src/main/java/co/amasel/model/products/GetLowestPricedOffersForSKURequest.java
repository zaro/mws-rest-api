...
@XmlType(name = "GetLowestPricedOffersForSKURequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "sellerSKU", "itemCondition"})
@XmlRootElement(name = "GetLowestPricedOffersForSKURequest")
public class GetLowestPricedOffersForSKURequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKURequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKURequest withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKURequest withItemCondition(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersForSKURequest", this);
	}

	/** Value constructor. */
	public GetLowestPricedOffersForSKURequest(String sellerId,
