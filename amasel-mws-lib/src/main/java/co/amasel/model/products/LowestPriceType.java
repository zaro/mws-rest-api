...
@XmlType(name = "LowestPriceType", propOrder = {"landedPrice", "listingPrice",
		"shipping", "points"})
@XmlRootElement(name = "LowestPriceType")
public class LowestPriceType extends AmaselMwsObject {
	...
	public void readFragmentFrom(MwsReader r) {
		...
		fulfillmentChannel = r
				.readAttribute("fulfillmentChannel", String.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"LowestPriceType", this);
	}

	/** Value constructor. */
	public LowestPriceType(String condition, String fulfillmentChannel,
			MoneyType landedPrice, MoneyType listingPrice, MoneyType shipping,
			Points points) {
		this.condition = condition;
		this.fulfillmentChannel = fulfillmentChannel;
		this.landedPrice = landedPrice;
