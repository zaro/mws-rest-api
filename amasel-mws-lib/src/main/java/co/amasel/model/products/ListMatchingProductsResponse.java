...
@XmlType(name = "ListMatchingProductsResponse", propOrder = {
		"listMatchingProductsResult", "responseMetadata"})
@XmlRootElement(name = "ListMatchingProductsResponse")
public class ListMatchingProductsResponse extends AmaselMwsObject {
	 ...
	 */
	public void setListMatchingProductsResult(
	 ...
	 */
	public ListMatchingProductsResponse withListMatchingProductsResult(
			ListMatchingProductsResult listMatchingProductsResult) {
		this.listMatchingProductsResult = listMatchingProductsResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMatchingProductsResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public ListMatchingProductsResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		listMatchingProductsResult = r.read("ListMatchingProductsResult",
				ListMatchingProductsResult.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"ListMatchingProductsResponse", this);
	}
