...
@XmlType(name = "GetProductCategoriesForSKUResponse", propOrder = {
		"getProductCategoriesForSKUResult", "responseMetadata"})
@XmlRootElement(name = "GetProductCategoriesForSKUResponse")
public class GetProductCategoriesForSKUResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetProductCategoriesForSKUResult(
	 ...
	 */
	public GetProductCategoriesForSKUResponse withGetProductCategoriesForSKUResult(
			GetProductCategoriesForSKUResult getProductCategoriesForSKUResult) {
		this.getProductCategoriesForSKUResult = getProductCategoriesForSKUResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForSKUResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForSKUResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getProductCategoriesForSKUResult = r.read(
				"GetProductCategoriesForSKUResult",
				GetProductCategoriesForSKUResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.write("GetProductCategoriesForSKUResult",
				getProductCategoriesForSKUResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetProductCategoriesForSKUResponse", this);
	}
