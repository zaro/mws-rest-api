...
@XmlType(name = "GetMatchingProductForIdRequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "idType", "idList"})
@XmlRootElement(name = "GetMatchingProductForIdRequest")
public class GetMatchingProductForIdRequest extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMatchingProductForIdRequest", this);
	}

	/** Value constructor. */
	public GetMatchingProductForIdRequest(String sellerId, String mwsAuthToken,
			String marketplaceId, String idType, IdListType idList) {
		this.sellerId = sellerId;
		this.mwsAuthToken = mwsAuthToken;
		this.marketplaceId = marketplaceId;
		this.idType = idType;
	...
	public GetMatchingProductForIdRequest(String sellerId,
			String marketplaceId, String idType, IdListType idList) {
		this.sellerId = sellerId;
		this.marketplaceId = marketplaceId;
		this.idType = idType;
