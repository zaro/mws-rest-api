...
@XmlType(name = "CompetitivePriceList", propOrder = {"competitivePrice"})
@XmlRootElement(name = "CompetitivePriceList")
public class CompetitivePriceList extends AmaselMwsObject {
	 ...
	 */
	public CompetitivePriceList withCompetitivePrice(
			CompetitivePriceType... values) {
	...
	public void readFragmentFrom(MwsReader r) {
		competitivePrice = r.readList("CompetitivePrice",
				CompetitivePriceType.class);
	}
