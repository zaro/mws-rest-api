...
@XmlType(name = "ASINOfferDetail", propOrder = {"subCondition",
		"sellerFeedbackRating", "shippingTime", "listingPrice", "points",
		"shipping", "shipsFrom", "isFulfilledByAmazon", "isBuyBoxWinner",
		"isFeaturedMerchant"})
@XmlRootElement(name = "ASINOfferDetail")
public class ASINOfferDetail extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public ASINOfferDetail withSellerFeedbackRating(
			SellerFeedbackType sellerFeedbackRating) {
		this.sellerFeedbackRating = sellerFeedbackRating;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ASINOfferDetail withShippingTime(
			DetailedShippingTimeType shippingTime) {
		this.shippingTime = shippingTime;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		sellerFeedbackRating = r.read("SellerFeedbackRating",
				SellerFeedbackType.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"ASINOfferDetail", this);
	}

	/** Value constructor. */
	public ASINOfferDetail(String subCondition,
			SellerFeedbackType sellerFeedbackRating,
			DetailedShippingTimeType shippingTime, MoneyType listingPrice,
			Points points, MoneyType shipping, ShipsFromType shipsFrom,
			boolean isFulfilledByAmazon, Boolean isBuyBoxWinner,
			Boolean isFeaturedMerchant) {
		this.subCondition = subCondition;
		this.sellerFeedbackRating = sellerFeedbackRating;
		this.shippingTime = shippingTime;
		this.listingPrice = listingPrice;
