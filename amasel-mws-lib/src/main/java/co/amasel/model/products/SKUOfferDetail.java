...
@XmlType(name = "SKUOfferDetail", propOrder = {"myOffer", "subCondition",
...
public class SKUOfferDetail extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public SKUOfferDetail withSellerFeedbackRating(
	...
	/** Value constructor. */
	public SKUOfferDetail(boolean myOffer, String subCondition,
			SellerFeedbackType sellerFeedbackRating,
