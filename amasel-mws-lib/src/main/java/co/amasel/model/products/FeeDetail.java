...
@XmlType(name = "FeeDetail", propOrder = {"feeType", "feeAmount",
		"feePromotion", "taxAmount", "finalFee", "includedFeeDetailList"})
@XmlRootElement(name = "FeeDetail")
public class FeeDetail extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public FeeDetail withIncludedFeeDetailList(
			FeeDetailList includedFeeDetailList) {
		this.includedFeeDetailList = includedFeeDetailList;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		includedFeeDetailList = r.read("IncludedFeeDetailList",
				FeeDetailList.class);
	}
	...
	/** Value constructor. */
	public FeeDetail(String feeType, MoneyType feeAmount,
			MoneyType feePromotion, MoneyType taxAmount, MoneyType finalFee,
			FeeDetailList includedFeeDetailList) {
		this.feeType = feeType;
		this.feeAmount = feeAmount;
		this.feePromotion = feePromotion;
