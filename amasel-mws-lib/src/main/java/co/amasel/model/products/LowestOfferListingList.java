...
public class LowestOfferListingList extends AmaselMwsObject {
	 ...
	 */
	public void setLowestOfferListing(
			List<LowestOfferListingType> lowestOfferListing) {
	 ...
	 */
	public LowestOfferListingList withLowestOfferListing(
			LowestOfferListingType... values) {
	...
	public void readFragmentFrom(MwsReader r) {
		lowestOfferListing = r.readList("LowestOfferListing",
				LowestOfferListingType.class);
	}
