...
@XmlType(name = "BuyBoxPriceType", propOrder = {"landedPrice", "listingPrice",
		"shipping", "points"})
@XmlRootElement(name = "BuyBoxPriceType")
public class BuyBoxPriceType extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"BuyBoxPriceType", this);
	}

	/** Value constructor. */
	public BuyBoxPriceType(String condition, MoneyType landedPrice,
			MoneyType listingPrice, MoneyType shipping, Points points) {
		this.condition = condition;
		this.landedPrice = landedPrice;
		this.listingPrice = listingPrice;
		this.shipping = shipping;
