...
@XmlType(name = "GetProductCategoriesForSKURequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "sellerSKU"})
@XmlRootElement(name = "GetProductCategoriesForSKURequest")
public class GetProductCategoriesForSKURequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForSKURequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForSKURequest withMarketplaceId(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetProductCategoriesForSKURequest", this);
	}

	/** Value constructor. */
	public GetProductCategoriesForSKURequest(String sellerId,
