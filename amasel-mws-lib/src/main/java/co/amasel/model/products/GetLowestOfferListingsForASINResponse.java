...
@XmlType(name = "GetLowestOfferListingsForASINResponse", propOrder = {
		"getLowestOfferListingsForASINResult", "responseMetadata"})
@XmlRootElement(name = "GetLowestOfferListingsForASINResponse")
public class GetLowestOfferListingsForASINResponse extends AmaselMwsObject {
	...
	public boolean isSetGetLowestOfferListingsForASINResult() {
		return getLowestOfferListingsForASINResult != null
				&& !getLowestOfferListingsForASINResult.isEmpty();
	}
	 ...
	 */
	public GetLowestOfferListingsForASINResponse withGetLowestOfferListingsForASINResult(
			GetLowestOfferListingsForASINResult... values) {
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForASINResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForASINResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getLowestOfferListingsForASINResult = r.readList(
				"GetLowestOfferListingsForASINResult",
				GetLowestOfferListingsForASINResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.writeList("GetLowestOfferListingsForASINResult",
				getLowestOfferListingsForASINResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestOfferListingsForASINResponse", this);
	}
