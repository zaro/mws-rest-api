...
@XmlType(name = "GetProductCategoriesForASINRequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "asin"})
@XmlRootElement(name = "GetProductCategoriesForASINRequest")
public class GetProductCategoriesForASINRequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForASINRequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForASINRequest withMarketplaceId(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetProductCategoriesForASINRequest", this);
	}

	/** Value constructor. */
	public GetProductCategoriesForASINRequest(String sellerId,
