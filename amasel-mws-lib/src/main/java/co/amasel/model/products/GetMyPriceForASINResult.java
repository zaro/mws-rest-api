...
@XmlType(name = "GetMyPriceForASINResult", propOrder = {"product", "error"})
@XmlRootElement(name = "GetMyPriceForASINResult")
public class GetMyPriceForASINResult extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMyPriceForASINResult", this);
	}

	/** Value constructor. */
	public GetMyPriceForASINResult(Product product, Error error, String asin,
			String status) {
		this.product = product;
		this.error = error;
		this.asin = asin;
