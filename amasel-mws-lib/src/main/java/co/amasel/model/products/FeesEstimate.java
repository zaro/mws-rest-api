...
@XmlType(name = "FeesEstimate", propOrder = {"timeOfFeesEstimation",
		"totalFeesEstimate", "feeDetailList"})
@XmlRootElement(name = "FeesEstimate")
public class FeesEstimate extends AmaselMwsObject {
	 ...
	 */
	public void setTimeOfFeesEstimation(
			XMLGregorianCalendar timeOfFeesEstimation) {
	 ...
	 */
	public FeesEstimate withTimeOfFeesEstimation(
			XMLGregorianCalendar timeOfFeesEstimation) {
		this.timeOfFeesEstimation = timeOfFeesEstimation;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		timeOfFeesEstimation = r.read("TimeOfFeesEstimation",
	...
	/** Value constructor. */
	public FeesEstimate(XMLGregorianCalendar timeOfFeesEstimation,
			MoneyType totalFeesEstimate, FeeDetailList feeDetailList) {
		this.timeOfFeesEstimation = timeOfFeesEstimation;
		this.totalFeesEstimate = totalFeesEstimate;
		this.feeDetailList = feeDetailList;
	}
