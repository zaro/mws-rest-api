...
@XmlType(name = "GetLowestPricedOffersForSKUResult", propOrder = {"identifier",
		"summary", "offers"})
@XmlRootElement(name = "GetLowestPricedOffersForSKUResult")
public class GetLowestPricedOffersForSKUResult extends AmaselMwsObject {
	 ...
	 */
	public GetLowestPricedOffersForSKUResult withMarketplaceID(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKUResult withItemCondition(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKUResult withIdentifier(
			GetLowestPricedOffersSkuIdentifier identifier) {
		this.identifier = identifier;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKUResult withOffers(
			SKUOfferDetailList offers) {
		this.offers = offers;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		identifier = r.read("Identifier",
				GetLowestPricedOffersSkuIdentifier.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersForSKUResult", this);
	}

	/** Value constructor. */
	public GetLowestPricedOffersForSKUResult(String marketplaceID, String sku,
			String itemCondition, String status,
			GetLowestPricedOffersSkuIdentifier identifier, Summary summary,
			SKUOfferDetailList offers) {
		this.marketplaceID = marketplaceID;
		this.sku = sku;
		this.itemCondition = itemCondition;
