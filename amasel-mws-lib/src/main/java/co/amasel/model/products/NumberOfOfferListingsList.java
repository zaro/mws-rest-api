...
@XmlType(name = "NumberOfOfferListingsList", propOrder = {"offerListingCount"})
@XmlRootElement(name = "NumberOfOfferListingsList")
public class NumberOfOfferListingsList extends AmaselMwsObject {
	 ...
	 */
	public void setOfferListingCount(
			List<OfferListingCountType> offerListingCount) {
	 ...
	 */
	public NumberOfOfferListingsList withOfferListingCount(
			OfferListingCountType... values) {
	...
	public void readFragmentFrom(MwsReader r) {
		offerListingCount = r.readList("OfferListingCount",
				OfferListingCountType.class);
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"NumberOfOfferListingsList", this);
	}
