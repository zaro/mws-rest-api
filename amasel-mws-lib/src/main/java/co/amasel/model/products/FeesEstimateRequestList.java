...
@XmlType(name = "FeesEstimateRequestList", propOrder = {"feesEstimateRequest"})
@XmlRootElement(name = "FeesEstimateRequestList")
public class FeesEstimateRequestList extends AmaselMwsObject {
	 ...
	 */
	public void setFeesEstimateRequest(
	 ...
	 */
	public FeesEstimateRequestList withFeesEstimateRequest(
			FeesEstimateRequest... values) {
	...
	public void readFragmentFrom(MwsReader r) {
		feesEstimateRequest = r.readList("FeesEstimateRequest",
				FeesEstimateRequest.class);
	}
