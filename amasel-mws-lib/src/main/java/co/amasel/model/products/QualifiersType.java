...
@XmlType(name = "QualifiersType", propOrder = {"itemCondition",
		"itemSubcondition", "fulfillmentChannel", "shipsDomestically",
		"shippingTime", "sellerPositiveFeedbackRating"})
@XmlRootElement(name = "QualifiersType")
public class QualifiersType extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setSellerPositiveFeedbackRating(
	 ...
	 * @return This instance.
	 */
	public QualifiersType withSellerPositiveFeedbackRating(
			String sellerPositiveFeedbackRating) {
		this.sellerPositiveFeedbackRating = sellerPositiveFeedbackRating;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		sellerPositiveFeedbackRating = r.read("SellerPositiveFeedbackRating",
				String.class);
	}
	...
	/** Value constructor. */
	public QualifiersType(String itemCondition, String itemSubcondition,
			String fulfillmentChannel, String shipsDomestically,
			ShippingTimeType shippingTime, String sellerPositiveFeedbackRating) {
		this.itemCondition = itemCondition;
		this.itemSubcondition = itemSubcondition;
		this.fulfillmentChannel = fulfillmentChannel;
		this.shipsDomestically = shipsDomestically;
