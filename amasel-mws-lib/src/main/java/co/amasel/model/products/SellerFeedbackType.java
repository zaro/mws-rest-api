...
@XmlType(name = "SellerFeedbackType", propOrder = {
		"sellerPositiveFeedbackRating", "feedbackCount"})
@XmlRootElement(name = "SellerFeedbackType")
public class SellerFeedbackType extends AmaselMwsObject {
	...
	public void setSellerPositiveFeedbackRating(
			Double sellerPositiveFeedbackRating) {
	 ...
	 */
	public SellerFeedbackType withSellerPositiveFeedbackRating(
			Double sellerPositiveFeedbackRating) {
		this.sellerPositiveFeedbackRating = sellerPositiveFeedbackRating;
		return this;
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"SellerFeedbackType", this);
	}

	/** Value constructor. */
	public SellerFeedbackType(Double sellerPositiveFeedbackRating,
			long feedbackCount) {
		this.sellerPositiveFeedbackRating = sellerPositiveFeedbackRating;
		this.feedbackCount = feedbackCount;
	}
