...
@XmlType(name = "CompetitivePricingType", propOrder = {"competitivePrices",
		"numberOfOfferListings", "tradeInValue"})
@XmlRootElement(name = "CompetitivePricingType")
public class CompetitivePricingType extends AmaselMwsObject {
	 ...
	 */
	public CompetitivePricingType withCompetitivePrices(
			CompetitivePriceList competitivePrices) {
		this.competitivePrices = competitivePrices;
		return this;
	}
	 ...
	 *            The new value to set.
	 */
	public void setNumberOfOfferListings(
	 ...
	 * @return This instance.
	 */
	public CompetitivePricingType withNumberOfOfferListings(
			NumberOfOfferListingsList numberOfOfferListings) {
		this.numberOfOfferListings = numberOfOfferListings;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		competitivePrices = r.read("CompetitivePrices",
				CompetitivePriceList.class);
		numberOfOfferListings = r.read("NumberOfOfferListings",
				NumberOfOfferListingsList.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"CompetitivePricingType", this);
	}

	/** Value constructor. */
	public CompetitivePricingType(CompetitivePriceList competitivePrices,
			NumberOfOfferListingsList numberOfOfferListings,
			MoneyType tradeInValue) {
		this.competitivePrices = competitivePrices;
		this.numberOfOfferListings = numberOfOfferListings;
		this.tradeInValue = tradeInValue;
	}
