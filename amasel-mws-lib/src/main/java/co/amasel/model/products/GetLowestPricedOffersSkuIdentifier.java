...
@XmlType(name = "GetLowestPricedOffersSkuIdentifier", propOrder = {
		"marketplaceId", "sellerSKU", "itemCondition", "timeOfOfferChange"})
@XmlRootElement(name = "GetLowestPricedOffersSkuIdentifier")
public class GetLowestPricedOffersSkuIdentifier extends AmaselMwsObject {
	 ...
	 */
	public GetLowestPricedOffersSkuIdentifier withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersSkuIdentifier withItemCondition(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersSkuIdentifier withTimeOfOfferChange(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersSkuIdentifier", this);
	}

	/** Value constructor. */
	public GetLowestPricedOffersSkuIdentifier(String marketplaceId,
