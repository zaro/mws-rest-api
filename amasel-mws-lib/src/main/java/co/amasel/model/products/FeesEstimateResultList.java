...
public class FeesEstimateResultList extends AmaselMwsObject {
	 ...
	 */
	public void setFeesEstimateResult(
			List<FeesEstimateResult> feesEstimateResult) {
	 ...
	 */
	public FeesEstimateResultList withFeesEstimateResult(
			FeesEstimateResult... values) {
	...
	public void readFragmentFrom(MwsReader r) {
		feesEstimateResult = r.readList("FeesEstimateResult",
				FeesEstimateResult.class);
	}
