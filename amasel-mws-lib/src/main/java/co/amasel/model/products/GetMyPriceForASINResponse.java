...
@XmlType(name = "GetMyPriceForASINResponse", propOrder = {
		"getMyPriceForASINResult", "responseMetadata"})
@XmlRootElement(name = "GetMyPriceForASINResponse")
public class GetMyPriceForASINResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetMyPriceForASINResult(
			List<GetMyPriceForASINResult> getMyPriceForASINResult) {
	...
	public boolean isSetGetMyPriceForASINResult() {
		return getMyPriceForASINResult != null
				&& !getMyPriceForASINResult.isEmpty();
	}
	 ...
	 */
	public GetMyPriceForASINResponse withGetMyPriceForASINResult(
			GetMyPriceForASINResult... values) {
	 ...
	 * @return This instance.
	 */
	public GetMyPriceForASINResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetMyPriceForASINResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getMyPriceForASINResult = r.readList("GetMyPriceForASINResult",
				GetMyPriceForASINResult.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMyPriceForASINResponse", this);
	}
