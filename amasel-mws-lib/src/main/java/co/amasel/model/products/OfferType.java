...
@XmlType(name = "OfferType", propOrder = {"buyingPrice", "regularPrice",
		"fulfillmentChannel", "itemCondition", "itemSubCondition", "sellerId",
		"sellerSKU"})
@XmlRootElement(name = "OfferType")
public class OfferType extends AmaselMwsObject {
	...
	/** Value constructor. */
	public OfferType(PriceType buyingPrice, MoneyType regularPrice,
			String fulfillmentChannel, String itemCondition,
			String itemSubCondition, String sellerId, String sellerSKU) {
		this.buyingPrice = buyingPrice;
		this.regularPrice = regularPrice;
		this.fulfillmentChannel = fulfillmentChannel;
		this.itemCondition = itemCondition;
