...
@XmlType(name = "PriceType", propOrder = {"landedPrice", "listingPrice",
		"shipping", "points"})
@XmlRootElement(name = "PriceType")
public class PriceType extends AmaselMwsObject {
	...
	/** Value constructor. */
	public PriceType(MoneyType landedPrice, MoneyType listingPrice,
			MoneyType shipping, Points points) {
		this.landedPrice = landedPrice;
		this.listingPrice = listingPrice;
		this.shipping = shipping;
		this.points = points;
