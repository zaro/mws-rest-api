...
@XmlType(name = "GetLowestOfferListingsForSKURequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "sellerSKUList", "itemCondition",
		"excludeMe"})
@XmlRootElement(name = "GetLowestOfferListingsForSKURequest")
public class GetLowestOfferListingsForSKURequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForSKURequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForSKURequest withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForSKURequest withSellerSKUList(
			SellerSKUListType sellerSKUList) {
		this.sellerSKUList = sellerSKUList;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForSKURequest withItemCondition(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestOfferListingsForSKURequest", this);
	}

	/** Value constructor. */
	public GetLowestOfferListingsForSKURequest(String sellerId,
			String mwsAuthToken, String marketplaceId,
			SellerSKUListType sellerSKUList, String itemCondition,
			Boolean excludeMe) {
		this.sellerId = sellerId;
		this.mwsAuthToken = mwsAuthToken;
		this.marketplaceId = marketplaceId;
	...
	public GetLowestOfferListingsForSKURequest(String sellerId,
			String marketplaceId, SellerSKUListType sellerSKUList,
