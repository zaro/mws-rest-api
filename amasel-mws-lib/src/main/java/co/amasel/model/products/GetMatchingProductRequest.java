...
@XmlType(name = "GetMatchingProductRequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "asinList"})
@XmlRootElement(name = "GetMatchingProductRequest")
public class GetMatchingProductRequest extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMatchingProductRequest", this);
	}

	/** Value constructor. */
	public GetMatchingProductRequest(String sellerId, String mwsAuthToken,
	...
	public GetMatchingProductRequest(String sellerId, String marketplaceId,
