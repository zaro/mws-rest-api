...
@XmlType(name = "FeesEstimateResult", propOrder = {"status",
		"feesEstimateIdentifier", "feesEstimate", "error"})
@XmlRootElement(name = "FeesEstimateResult")
public class FeesEstimateResult extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setFeesEstimateIdentifier(
	 ...
	 * @return This instance.
	 */
	public FeesEstimateResult withFeesEstimateIdentifier(
			FeesEstimateIdentifier feesEstimateIdentifier) {
		this.feesEstimateIdentifier = feesEstimateIdentifier;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		feesEstimateIdentifier = r.read("FeesEstimateIdentifier",
				FeesEstimateIdentifier.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"FeesEstimateResult", this);
	}

	/** Value constructor. */
	public FeesEstimateResult(String status,
			FeesEstimateIdentifier feesEstimateIdentifier,
			FeesEstimate feesEstimate, Error error) {
		this.status = status;
		this.feesEstimateIdentifier = feesEstimateIdentifier;
		this.feesEstimate = feesEstimate;
		this.error = error;
