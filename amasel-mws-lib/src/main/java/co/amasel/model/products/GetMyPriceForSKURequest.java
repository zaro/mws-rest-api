...
@XmlType(name = "GetMyPriceForSKURequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "sellerSKUList"})
@XmlRootElement(name = "GetMyPriceForSKURequest")
public class GetMyPriceForSKURequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetMyPriceForSKURequest withSellerSKUList(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMyPriceForSKURequest", this);
	}

	/** Value constructor. */
	public GetMyPriceForSKURequest(String sellerId, String mwsAuthToken,
	...
	public GetMyPriceForSKURequest(String sellerId, String marketplaceId,
			SellerSKUListType sellerSKUList) {
		this.sellerId = sellerId;
		this.marketplaceId = marketplaceId;
		this.sellerSKUList = sellerSKUList;
