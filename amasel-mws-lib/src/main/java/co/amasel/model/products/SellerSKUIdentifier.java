...
@XmlType(name = "SellerSKUIdentifier", propOrder = {"marketplaceId",
		"sellerId", "sellerSKU"})
@XmlRootElement(name = "SellerSKUIdentifier")
public class SellerSKUIdentifier extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"SellerSKUIdentifier", this);
	}

	/** Value constructor. */
	public SellerSKUIdentifier(String marketplaceId, String sellerId,
			String sellerSKU) {
		this.marketplaceId = marketplaceId;
		this.sellerId = sellerId;
		this.sellerSKU = sellerSKU;
