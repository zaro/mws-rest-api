...
@XmlType(name = "GetMatchingProductResponse", propOrder = {
		"getMatchingProductResult", "responseMetadata"})
@XmlRootElement(name = "GetMatchingProductResponse")
public class GetMatchingProductResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetMatchingProductResult(
			List<GetMatchingProductResult> getMatchingProductResult) {
	...
	public boolean isSetGetMatchingProductResult() {
		return getMatchingProductResult != null
				&& !getMatchingProductResult.isEmpty();
	}
	 ...
	 */
	public GetMatchingProductResponse withGetMatchingProductResult(
			GetMatchingProductResult... values) {
	 ...
	 * @return This instance.
	 */
	public GetMatchingProductResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetMatchingProductResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getMatchingProductResult = r.readList("GetMatchingProductResult",
				GetMatchingProductResult.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMatchingProductResponse", this);
	}
