...
@XmlType(name = "GetLowestPricedOffersForASINResult", propOrder = {
		"identifier", "summary", "offers"})
@XmlRootElement(name = "GetLowestPricedOffersForASINResult")
public class GetLowestPricedOffersForASINResult extends AmaselMwsObject {
	 ...
	 */
	public GetLowestPricedOffersForASINResult withMarketplaceID(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForASINResult withItemCondition(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForASINResult withIdentifier(
			GetLowestPricedOffersAsinIdentifier identifier) {
		this.identifier = identifier;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForASINResult withOffers(
			ASINOfferDetailList offers) {
		this.offers = offers;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		identifier = r.read("Identifier",
				GetLowestPricedOffersAsinIdentifier.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersForASINResult", this);
	}

	/** Value constructor. */
	public GetLowestPricedOffersForASINResult(String marketplaceID,
			String asin, String itemCondition, String status,
			GetLowestPricedOffersAsinIdentifier identifier, Summary summary,
			ASINOfferDetailList offers) {
		this.marketplaceID = marketplaceID;
		this.asin = asin;
		this.itemCondition = itemCondition;
