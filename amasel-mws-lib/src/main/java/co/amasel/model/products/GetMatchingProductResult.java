...
public class GetMatchingProductResult extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMatchingProductResult", this);
	}

	/** Value constructor. */
	public GetMatchingProductResult(Product product, Error error, String asin,
			String status) {
		this.product = product;
		this.error = error;
		this.asin = asin;
