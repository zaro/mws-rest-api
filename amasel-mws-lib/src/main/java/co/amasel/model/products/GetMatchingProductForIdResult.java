...
@XmlType(name = "GetMatchingProductForIdResult", propOrder = {"products",
		"error"})
@XmlRootElement(name = "GetMatchingProductForIdResult")
public class GetMatchingProductForIdResult extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMatchingProductForIdResult", this);
	}

	/** Value constructor. */
	public GetMatchingProductForIdResult(ProductList products, Error error,
			String id, String idType, String status) {
		this.products = products;
		this.error = error;
		this.id = id;
		this.idType = idType;
