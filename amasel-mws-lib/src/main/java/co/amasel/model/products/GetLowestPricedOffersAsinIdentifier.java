...
@XmlType(name = "GetLowestPricedOffersAsinIdentifier", propOrder = {
		"marketplaceId", "asin", "itemCondition", "timeOfOfferChange"})
@XmlRootElement(name = "GetLowestPricedOffersAsinIdentifier")
public class GetLowestPricedOffersAsinIdentifier extends AmaselMwsObject {
	 ...
	 */
	public GetLowestPricedOffersAsinIdentifier withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersAsinIdentifier withItemCondition(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersAsinIdentifier withTimeOfOfferChange(
			XMLGregorianCalendar timeOfOfferChange) {
		this.timeOfOfferChange = timeOfOfferChange;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		timeOfOfferChange = r.read("TimeOfOfferChange",
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersAsinIdentifier", this);
	}

	/** Value constructor. */
	public GetLowestPricedOffersAsinIdentifier(String marketplaceId,
