...
@XmlType(name = "GetLowestOfferListingsForSKUResponse", propOrder = {
		"getLowestOfferListingsForSKUResult", "responseMetadata"})
@XmlRootElement(name = "GetLowestOfferListingsForSKUResponse")
public class GetLowestOfferListingsForSKUResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetLowestOfferListingsForSKUResult(
			List<GetLowestOfferListingsForSKUResult> getLowestOfferListingsForSKUResult) {
	...
	public boolean isSetGetLowestOfferListingsForSKUResult() {
		return getLowestOfferListingsForSKUResult != null
				&& !getLowestOfferListingsForSKUResult.isEmpty();
	}
	 ...
	 */
	public GetLowestOfferListingsForSKUResponse withGetLowestOfferListingsForSKUResult(
			GetLowestOfferListingsForSKUResult... values) {
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForSKUResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForSKUResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getLowestOfferListingsForSKUResult = r.readList(
				"GetLowestOfferListingsForSKUResult",
				GetLowestOfferListingsForSKUResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.writeList("GetLowestOfferListingsForSKUResult",
				getLowestOfferListingsForSKUResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestOfferListingsForSKUResponse", this);
	}
