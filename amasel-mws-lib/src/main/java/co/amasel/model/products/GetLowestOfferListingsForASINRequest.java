...
@XmlType(name = "GetLowestOfferListingsForASINRequest", propOrder = {
		"sellerId", "mwsAuthToken", "marketplaceId", "asinList",
		"itemCondition", "excludeMe"})
@XmlRootElement(name = "GetLowestOfferListingsForASINRequest")
public class GetLowestOfferListingsForASINRequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForASINRequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForASINRequest withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForASINRequest withASINList(
	 ...
	 * @return This instance.
	 */
	public GetLowestOfferListingsForASINRequest withItemCondition(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestOfferListingsForASINRequest", this);
	}

	/** Value constructor. */
	public GetLowestOfferListingsForASINRequest(String sellerId,
	...
	public GetLowestOfferListingsForASINRequest(String sellerId,
			String marketplaceId, ASINListType asinList, String itemCondition,
			Boolean excludeMe) {
		this.sellerId = sellerId;
		this.marketplaceId = marketplaceId;
		this.asinList = asinList;
