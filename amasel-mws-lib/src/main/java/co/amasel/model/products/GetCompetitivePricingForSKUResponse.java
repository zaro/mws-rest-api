...
@XmlType(name = "GetCompetitivePricingForSKUResponse", propOrder = {
		"getCompetitivePricingForSKUResult", "responseMetadata"})
@XmlRootElement(name = "GetCompetitivePricingForSKUResponse")
public class GetCompetitivePricingForSKUResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetCompetitivePricingForSKUResult(
			List<GetCompetitivePricingForSKUResult> getCompetitivePricingForSKUResult) {
	...
	public boolean isSetGetCompetitivePricingForSKUResult() {
		return getCompetitivePricingForSKUResult != null
				&& !getCompetitivePricingForSKUResult.isEmpty();
	}
	 ...
	 */
	public GetCompetitivePricingForSKUResponse withGetCompetitivePricingForSKUResult(
			GetCompetitivePricingForSKUResult... values) {
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForSKUResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForSKUResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getCompetitivePricingForSKUResult = r.readList(
				"GetCompetitivePricingForSKUResult",
				GetCompetitivePricingForSKUResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.writeList("GetCompetitivePricingForSKUResult",
				getCompetitivePricingForSKUResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetCompetitivePricingForSKUResponse", this);
	}
