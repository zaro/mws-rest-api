...
@XmlType(name = "FeesEstimateIdentifier", propOrder = {"marketplaceId",
		"sellerId", "idType", "idValue", "isAmazonFulfilled",
		"priceToEstimateFees", "sellerInputIdentifier"})
@XmlRootElement(name = "FeesEstimateIdentifier")
public class FeesEstimateIdentifier extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public FeesEstimateIdentifier withIsAmazonFulfilled(
			Boolean isAmazonFulfilled) {
		this.isAmazonFulfilled = isAmazonFulfilled;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public FeesEstimateIdentifier withPriceToEstimateFees(
	 ...
	 * @return This instance.
	 */
	public FeesEstimateIdentifier withSellerInputIdentifier(
			String sellerInputIdentifier) {
		this.sellerInputIdentifier = sellerInputIdentifier;
		return this;
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"FeesEstimateIdentifier", this);
	}

	/** Value constructor. */
	public FeesEstimateIdentifier(String marketplaceId, String sellerId,
			String idType, String idValue, Boolean isAmazonFulfilled,
			PriceToEstimateFees priceToEstimateFees,
			String sellerInputIdentifier) {
		this.marketplaceId = marketplaceId;
		this.sellerId = sellerId;
