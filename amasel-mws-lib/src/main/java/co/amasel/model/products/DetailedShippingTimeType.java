...
public class DetailedShippingTimeType extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public DetailedShippingTimeType withAvailableDate(
			XMLGregorianCalendar availableDate) {
		this.availableDate = availableDate;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		availableDate = r.readAttribute("availableDate",
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"DetailedShippingTimeType", this);
	}

	/** Value constructor. */
	public DetailedShippingTimeType(Long minimumHours, Long maximumHours,
			XMLGregorianCalendar availableDate, String availabilityType) {
		this.minimumHours = minimumHours;
		this.maximumHours = maximumHours;
		this.availableDate = availableDate;
		this.availabilityType = availabilityType;
