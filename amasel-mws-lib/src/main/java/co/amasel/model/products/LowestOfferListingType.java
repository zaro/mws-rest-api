...
@XmlType(name = "LowestOfferListingType", propOrder = {"qualifiers",
		"numberOfOfferListingsConsidered", "sellerFeedbackCount", "price",
		"multipleOffersAtLowestPrice"})
@XmlRootElement(name = "LowestOfferListingType")
public class LowestOfferListingType extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setNumberOfOfferListingsConsidered(
			Integer numberOfOfferListingsConsidered) {
	 ...
	 * @return This instance.
	 */
	public LowestOfferListingType withNumberOfOfferListingsConsidered(
			Integer numberOfOfferListingsConsidered) {
		this.numberOfOfferListingsConsidered = numberOfOfferListingsConsidered;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public LowestOfferListingType withSellerFeedbackCount(
	 ...
	 *            The new value to set.
	 */
	public void setMultipleOffersAtLowestPrice(
	 ...
	 * @return This instance.
	 */
	public LowestOfferListingType withMultipleOffersAtLowestPrice(
			String multipleOffersAtLowestPrice) {
		this.multipleOffersAtLowestPrice = multipleOffersAtLowestPrice;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		numberOfOfferListingsConsidered = r.read(
				"NumberOfOfferListingsConsidered", Integer.class);
		sellerFeedbackCount = r.read("SellerFeedbackCount", int.class);
		price = r.read("Price", PriceType.class);
		multipleOffersAtLowestPrice = r.read("MultipleOffersAtLowestPrice",
				String.class);
	}
	...
	public void writeFragmentTo(MwsWriter w) {
		...
		w.write("NumberOfOfferListingsConsidered",
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"LowestOfferListingType", this);
	}

	/** Value constructor. */
	public LowestOfferListingType(QualifiersType qualifiers,
			Integer numberOfOfferListingsConsidered, int sellerFeedbackCount,
			PriceType price, String multipleOffersAtLowestPrice) {
		this.qualifiers = qualifiers;
		this.numberOfOfferListingsConsidered = numberOfOfferListingsConsidered;
		this.sellerFeedbackCount = sellerFeedbackCount;
		this.price = price;
