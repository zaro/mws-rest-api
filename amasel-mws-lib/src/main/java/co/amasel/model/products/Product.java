...
@XmlType(name = "Product", propOrder = {"identifiers", "attributeSets",
		"relationships", "competitivePricing", "salesRankings",
		"lowestOfferListings", "offers"})
@XmlRootElement(name = "Product")
public class Product extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public Product withCompetitivePricing(
	 ...
	 *            The new value to set.
	 */
	public void setLowestOfferListings(
			LowestOfferListingList lowestOfferListings) {
	 ...
	 * @return This instance.
	 */
	public Product withLowestOfferListings(
			LowestOfferListingList lowestOfferListings) {
		this.lowestOfferListings = lowestOfferListings;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		competitivePricing = r.read("CompetitivePricing",
				CompetitivePricingType.class);
		salesRankings = r.read("SalesRankings", SalesRankList.class);
		lowestOfferListings = r.read("LowestOfferListings",
				LowestOfferListingList.class);
	...
	/** Value constructor. */
	public Product(IdentifierType identifiers, AttributeSetList attributeSets,
			RelationshipList relationships,
			CompetitivePricingType competitivePricing,
			SalesRankList salesRankings,
			LowestOfferListingList lowestOfferListings, OffersList offers) {
		this.identifiers = identifiers;
		this.attributeSets = attributeSets;
		this.relationships = relationships;
		this.competitivePricing = competitivePricing;
