...
@XmlType(name = "Categories", propOrder = {"productCategoryId",
		"productCategoryName", "parent"})
@XmlRootElement(name = "Categories")
public class Categories extends AmaselMwsObject {
	...
	/** Value constructor. */
	public Categories(String productCategoryId, String productCategoryName,
			Categories parent) {
		this.productCategoryId = productCategoryId;
		this.productCategoryName = productCategoryName;
		this.parent = parent;
