...
@XmlType(name = "PriceToEstimateFees", propOrder = {"listingPrice", "shipping",
		"points"})
@XmlRootElement(name = "PriceToEstimateFees")
public class PriceToEstimateFees extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"PriceToEstimateFees", this);
	}

	/** Value constructor. */
	public PriceToEstimateFees(MoneyType listingPrice, MoneyType shipping,
			Points points) {
		this.listingPrice = listingPrice;
		this.shipping = shipping;
		this.points = points;
