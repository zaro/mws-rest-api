...
@XmlType(name = "CompetitivePriceType", propOrder = {"competitivePriceId",
		"price"})
@XmlRootElement(name = "CompetitivePriceType")
public class CompetitivePriceType extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public CompetitivePriceType withBelongsToRequester(
			Boolean belongsToRequester) {
		this.belongsToRequester = belongsToRequester;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		belongsToRequester = r.readAttribute("belongsToRequester",
				Boolean.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"CompetitivePriceType", this);
	}

	/** Value constructor. */
	public CompetitivePriceType(String competitivePriceId, PriceType price,
			String condition, String subcondition, Boolean belongsToRequester) {
		this.competitivePriceId = competitivePriceId;
		this.price = price;
		this.condition = condition;
		this.subcondition = subcondition;
