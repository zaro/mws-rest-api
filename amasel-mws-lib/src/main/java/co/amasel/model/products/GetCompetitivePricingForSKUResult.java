...
@XmlType(name = "GetCompetitivePricingForSKUResult", propOrder = {"product",
		"error"})
@XmlRootElement(name = "GetCompetitivePricingForSKUResult")
public class GetCompetitivePricingForSKUResult extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetCompetitivePricingForSKUResult", this);
	}

	/** Value constructor. */
	public GetCompetitivePricingForSKUResult(Product product, Error error,
