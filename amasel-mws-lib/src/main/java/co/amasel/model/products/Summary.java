...
@XmlType(name = "Summary", propOrder = {"totalOfferCount", "numberOfOffers",
		"lowestPrices", "buyBoxPrices", "listPrice",
		"suggestedLowerPricePlusShipping", "buyBoxEligibleOffers"})
@XmlRootElement(name = "Summary")
public class Summary extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setSuggestedLowerPricePlusShipping(
	 ...
	 * @return This instance.
	 */
	public Summary withSuggestedLowerPricePlusShipping(
			MoneyType suggestedLowerPricePlusShipping) {
		this.suggestedLowerPricePlusShipping = suggestedLowerPricePlusShipping;
		return this;
	}
	 ...
	 *            The new value to set.
	 */
	public void setBuyBoxEligibleOffers(
	 ...
	 * @return This instance.
	 */
	public Summary withBuyBoxEligibleOffers(
			BuyBoxEligibleOffers buyBoxEligibleOffers) {
		this.buyBoxEligibleOffers = buyBoxEligibleOffers;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		suggestedLowerPricePlusShipping = r.read(
				"SuggestedLowerPricePlusShipping", MoneyType.class);
		buyBoxEligibleOffers = r.read("BuyBoxEligibleOffers",
				BuyBoxEligibleOffers.class);
	}
	...
	public void writeFragmentTo(MwsWriter w) {
		...
		w.write("SuggestedLowerPricePlusShipping",
	...
	/** Value constructor. */
	public Summary(int totalOfferCount, NumberOfOffers numberOfOffers,
			LowestPrices lowestPrices, BuyBoxPrices buyBoxPrices,
			MoneyType listPrice, MoneyType suggestedLowerPricePlusShipping,
			BuyBoxEligibleOffers buyBoxEligibleOffers) {
		this.totalOfferCount = totalOfferCount;
		this.numberOfOffers = numberOfOffers;
		this.lowestPrices = lowestPrices;
