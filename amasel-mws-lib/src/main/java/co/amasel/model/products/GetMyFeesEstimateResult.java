...
public class GetMyFeesEstimateResult extends AmaselMwsObject {
	 ...
	 */
	public void setFeesEstimateResultList(
			FeesEstimateResultList feesEstimateResultList) {
	 ...
	 */
	public GetMyFeesEstimateResult withFeesEstimateResultList(
			FeesEstimateResultList feesEstimateResultList) {
		this.feesEstimateResultList = feesEstimateResultList;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		feesEstimateResultList = r.read("FeesEstimateResultList",
				FeesEstimateResultList.class);
	}
