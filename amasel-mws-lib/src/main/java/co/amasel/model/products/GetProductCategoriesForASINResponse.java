...
@XmlType(name = "GetProductCategoriesForASINResponse", propOrder = {
		"getProductCategoriesForASINResult", "responseMetadata"})
@XmlRootElement(name = "GetProductCategoriesForASINResponse")
public class GetProductCategoriesForASINResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetProductCategoriesForASINResult(
	 ...
	 */
	public GetProductCategoriesForASINResponse withGetProductCategoriesForASINResult(
			GetProductCategoriesForASINResult getProductCategoriesForASINResult) {
		this.getProductCategoriesForASINResult = getProductCategoriesForASINResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForASINResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetProductCategoriesForASINResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getProductCategoriesForASINResult = r.read(
				"GetProductCategoriesForASINResult",
				GetProductCategoriesForASINResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.write("GetProductCategoriesForASINResult",
				getProductCategoriesForASINResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetProductCategoriesForASINResponse", this);
	}
