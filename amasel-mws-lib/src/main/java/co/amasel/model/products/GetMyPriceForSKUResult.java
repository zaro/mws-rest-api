...
@XmlType(name = "GetMyPriceForSKUResult", propOrder = {"product", "error"})
@XmlRootElement(name = "GetMyPriceForSKUResult")
public class GetMyPriceForSKUResult extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMyPriceForSKUResult", this);
	}

	/** Value constructor. */
	public GetMyPriceForSKUResult(Product product, Error error,
