...
@XmlType(name = "GetMyFeesEstimateRequest", propOrder = {"sellerId",
		"mwsAuthToken", "feesEstimateRequestList"})
@XmlRootElement(name = "GetMyFeesEstimateRequest")
public class GetMyFeesEstimateRequest extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setFeesEstimateRequestList(
	 ...
	 * @return This instance.
	 */
	public GetMyFeesEstimateRequest withFeesEstimateRequestList(
			FeesEstimateRequestList feesEstimateRequestList) {
		this.feesEstimateRequestList = feesEstimateRequestList;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		feesEstimateRequestList = r.read("FeesEstimateRequestList",
				FeesEstimateRequestList.class);
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMyFeesEstimateRequest", this);
	}

	/** Value constructor. */
	public GetMyFeesEstimateRequest(String sellerId, String mwsAuthToken,
			FeesEstimateRequestList feesEstimateRequestList) {
		this.sellerId = sellerId;
		this.mwsAuthToken = mwsAuthToken;
		this.feesEstimateRequestList = feesEstimateRequestList;
	...
	public GetMyFeesEstimateRequest(String sellerId,
			FeesEstimateRequestList feesEstimateRequestList) {
		this.sellerId = sellerId;
		this.feesEstimateRequestList = feesEstimateRequestList;
	}
