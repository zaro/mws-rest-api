...
@XmlType(name = "GetCompetitivePricingForSKURequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "sellerSKUList"})
@XmlRootElement(name = "GetCompetitivePricingForSKURequest")
public class GetCompetitivePricingForSKURequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForSKURequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForSKURequest withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForSKURequest withSellerSKUList(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetCompetitivePricingForSKURequest", this);
	}

	/** Value constructor. */
	public GetCompetitivePricingForSKURequest(String sellerId,
