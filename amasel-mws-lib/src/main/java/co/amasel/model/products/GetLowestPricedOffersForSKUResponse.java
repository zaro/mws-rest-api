...
@XmlType(name = "GetLowestPricedOffersForSKUResponse", propOrder = {
		"getLowestPricedOffersForSKUResult", "responseMetadata"})
@XmlRootElement(name = "GetLowestPricedOffersForSKUResponse")
public class GetLowestPricedOffersForSKUResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetLowestPricedOffersForSKUResult(
			GetLowestPricedOffersForSKUResult getLowestPricedOffersForSKUResult) {
	 ...
	 */
	public GetLowestPricedOffersForSKUResponse withGetLowestPricedOffersForSKUResult(
			GetLowestPricedOffersForSKUResult getLowestPricedOffersForSKUResult) {
		this.getLowestPricedOffersForSKUResult = getLowestPricedOffersForSKUResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKUResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForSKUResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getLowestPricedOffersForSKUResult = r.read(
				"GetLowestPricedOffersForSKUResult",
				GetLowestPricedOffersForSKUResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.write("GetLowestPricedOffersForSKUResult",
				getLowestPricedOffersForSKUResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersForSKUResponse", this);
	}
