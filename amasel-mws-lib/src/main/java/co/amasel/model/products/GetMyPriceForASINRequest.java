...
@XmlType(name = "GetMyPriceForASINRequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "asinList"})
@XmlRootElement(name = "GetMyPriceForASINRequest")
public class GetMyPriceForASINRequest extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMyPriceForASINRequest", this);
	}

	/** Value constructor. */
	public GetMyPriceForASINRequest(String sellerId, String mwsAuthToken,
	...
	public GetMyPriceForASINRequest(String sellerId, String marketplaceId,
