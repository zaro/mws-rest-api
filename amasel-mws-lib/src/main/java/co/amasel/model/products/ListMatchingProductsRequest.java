...
@XmlType(name = "ListMatchingProductsRequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "query", "queryContextId"})
@XmlRootElement(name = "ListMatchingProductsRequest")
public class ListMatchingProductsRequest extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"ListMatchingProductsRequest", this);
	}

	/** Value constructor. */
	public ListMatchingProductsRequest(String sellerId, String mwsAuthToken,
	...
	public ListMatchingProductsRequest(String sellerId, String marketplaceId,
