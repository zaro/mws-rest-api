...
@XmlType(name = "GetLowestPricedOffersForASINResponse", propOrder = {
		"getLowestPricedOffersForASINResult", "responseMetadata"})
@XmlRootElement(name = "GetLowestPricedOffersForASINResponse")
public class GetLowestPricedOffersForASINResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetLowestPricedOffersForASINResult(
			GetLowestPricedOffersForASINResult getLowestPricedOffersForASINResult) {
	 ...
	 */
	public GetLowestPricedOffersForASINResponse withGetLowestPricedOffersForASINResult(
			GetLowestPricedOffersForASINResult getLowestPricedOffersForASINResult) {
		this.getLowestPricedOffersForASINResult = getLowestPricedOffersForASINResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForASINResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetLowestPricedOffersForASINResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getLowestPricedOffersForASINResult = r.read(
				"GetLowestPricedOffersForASINResult",
				GetLowestPricedOffersForASINResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.write("GetLowestPricedOffersForASINResult",
				getLowestPricedOffersForASINResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetLowestPricedOffersForASINResponse", this);
	}
