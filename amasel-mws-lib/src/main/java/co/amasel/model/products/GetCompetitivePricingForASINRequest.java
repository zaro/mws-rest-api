...
@XmlType(name = "GetCompetitivePricingForASINRequest", propOrder = {"sellerId",
		"mwsAuthToken", "marketplaceId", "asinList"})
@XmlRootElement(name = "GetCompetitivePricingForASINRequest")
public class GetCompetitivePricingForASINRequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForASINRequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForASINRequest withMarketplaceId(
	 ...
	 * @return This instance.
	 */
	public GetCompetitivePricingForASINRequest withASINList(
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetCompetitivePricingForASINRequest", this);
	}

	/** Value constructor. */
	public GetCompetitivePricingForASINRequest(String sellerId,
	...
	public GetCompetitivePricingForASINRequest(String sellerId,
			String marketplaceId, ASINListType asinList) {
		this.sellerId = sellerId;
		this.marketplaceId = marketplaceId;
		this.asinList = asinList;
	}
