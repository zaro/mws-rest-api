...
@XmlType(name = "GetCompetitivePricingForASINResult", propOrder = {"product",
		"error"})
@XmlRootElement(name = "GetCompetitivePricingForASINResult")
public class GetCompetitivePricingForASINResult extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetCompetitivePricingForASINResult", this);
	}

	/** Value constructor. */
	public GetCompetitivePricingForASINResult(Product product, Error error,
