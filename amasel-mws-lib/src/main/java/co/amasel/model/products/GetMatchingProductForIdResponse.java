...
@XmlType(name = "GetMatchingProductForIdResponse", propOrder = {
		"getMatchingProductForIdResult", "responseMetadata"})
@XmlRootElement(name = "GetMatchingProductForIdResponse")
public class GetMatchingProductForIdResponse extends AmaselMwsObject {
	 ...
	 */
	public void setGetMatchingProductForIdResult(
	...
	public boolean isSetGetMatchingProductForIdResult() {
		return getMatchingProductForIdResult != null
				&& !getMatchingProductForIdResult.isEmpty();
	}
	 ...
	 */
	public GetMatchingProductForIdResponse withGetMatchingProductForIdResult(
			GetMatchingProductForIdResult... values) {
	 ...
	 * @return This instance.
	 */
	public GetMatchingProductForIdResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetMatchingProductForIdResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		getMatchingProductForIdResult = r.readList(
				"GetMatchingProductForIdResult",
				GetMatchingProductForIdResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.writeList("GetMatchingProductForIdResult",
				getMatchingProductForIdResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("http://mws.amazonservices.com/schema/Products/2011-10-01",
				"GetMatchingProductForIdResponse", this);
	}
