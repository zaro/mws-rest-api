...
@XmlType(name = "", propOrder = {"nextToken", "hasNext", "reportSchedule"})
@XmlRootElement(name = "GetReportScheduleListByNextTokenResult")
public class GetReportScheduleListByNextTokenResult extends AmaselMwsObject {
	 ...
	 * 
	 */
	public GetReportScheduleListByNextTokenResult(final String nextToken,
			final boolean hasNext, final List<ReportSchedule> reportSchedule) {
	 ...
	 * <CODE>set</CODE> method for the reportSchedule property.
	 * 
	 * <p>
	...
	public boolean isSetReportSchedule() {
		return ((this.reportSchedule != null) && (!this.reportSchedule
				.isEmpty()));
	}
	 ...
	 * @return this instance
	 */
	public GetReportScheduleListByNextTokenResult withReportScheduleList(
			ReportSchedule... values) {
	 ...
	 *            allowed object is {@link ReportSchedule }
	 * 
	 */
	...
	public String toJSONFragment() {
		...
		if (isSetReportSchedule()) {
			...
			java.util.List<ReportSchedule> reportScheduleList = getReportScheduleList();
			for (ReportSchedule reportSchedule : reportScheduleList) {
				if (reportScheduleList.indexOf(reportSchedule) > 0)
					json.append(", ");
				json.append("{");
				json.append("");
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		reportSchedule = (List) reader.readList("ReportSchedule",
