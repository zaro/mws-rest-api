...
@XmlType(name = "", propOrder = {"nextToken", "hasNext", "reportInfo"})
@XmlRootElement(name = "GetReportListByNextTokenResult")
public class GetReportListByNextTokenResult extends AmaselMwsObject {
	 ...
	 * 
	 */
	public GetReportListByNextTokenResult(final String nextToken,
			final boolean hasNext, final List<ReportInfo> reportInfo) {
	 ...
	 * <CODE>set</CODE> method for the reportInfo property.
	 * 
	 * <p>
	 ...
	 * @return this instance
	 */
	public GetReportListByNextTokenResult withReportInfoList(
			ReportInfo... values) {
	 ...
	 * 
	 * @param reportInfo
	 *            allowed object is {@link ReportInfo }
	 * 
	 */
	...
	public String toJSONFragment() {
		...
		if (isSetReportInfoList()) {
			...
			java.util.List<ReportInfo> reportInfoList = getReportInfoList();
			for (ReportInfo reportInfo : reportInfoList) {
				if (reportInfoList.indexOf(reportInfo) > 0)
					json.append(", ");
				json.append("{");
				json.append("");
