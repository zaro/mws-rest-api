...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "reportTypeList",
		"acknowledged", "availableFromDate", "availableToDate", "mwsAuthToken"})
@XmlRootElement(name = "GetReportCountRequest")
public class GetReportCountRequest extends AmaselMwsObject {
	 ...
	 * 
	 */
	public GetReportCountRequest(final String marketplace,
		...
		this(marketplace, merchant, reportTypeList, acknowledged,
				availableFromDate, availableToDate, null);
	}
	 ...
	 * @return this instance
	 */
	public GetReportCountRequest withAvailableFromDate(
