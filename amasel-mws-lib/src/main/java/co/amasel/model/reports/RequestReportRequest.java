...
@XmlType(name = "", propOrder = {"marketplace", "marketplaceIdList",
		"merchant", "reportType", "startDate", "endDate", "reportOptions",
		"mwsAuthToken"})
@XmlRootElement(name = "RequestReportRequest")
public class RequestReportRequest extends AmaselMwsObject {
	...
	public RequestReportRequest(final String marketplace,
			...
			final XMLGregorianCalendar endDate, final String reportOptions) {
		this(marketplace, marketplaceIdList, merchant, reportType, startDate,
				endDate, reportOptions, null);
	}
