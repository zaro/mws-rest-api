...
public class GetReportListResult extends AmaselMwsObject {
	 ...
	 * 
	 */
	public GetReportListResult(final String nextToken, final boolean hasNext,
			final List<ReportInfo> reportInfoList) {
	 ...
	 * <CODE>set</CODE> method for the reportInfoList property.
	 * 
	 * <p>
	...
	public String toJSONFragment() {
		...
		if (isSetReportInfoList()) {
			...
			java.util.List<ReportInfo> reportInfoListList = getReportInfoList();
			for (ReportInfo reportInfoList : reportInfoListList) {
				if (reportInfoListList.indexOf(reportInfoList) > 0)
					json.append(", ");
				json.append("{");
				json.append("");
