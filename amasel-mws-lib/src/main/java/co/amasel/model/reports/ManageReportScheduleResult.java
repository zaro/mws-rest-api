...
@XmlType(name = "", propOrder = {"count", "reportSchedule"})
@XmlRootElement(name = "ManageReportScheduleResult")
public class ManageReportScheduleResult extends AmaselMwsObject {
	 ...
	 * 
	 */
	public ManageReportScheduleResult(final int count,
			final List<ReportSchedule> reportSchedule) {
		this.count = count;
	 ...
	 * @return this instance
	 */
	public ManageReportScheduleResult withReportScheduleList(
