...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "reportTypeList",
		"reportProcessingStatusList", "requestedFromDate", "requestedToDate",
		"mwsAuthToken"})
@XmlRootElement(name = "GetReportRequestCountRequest")
public class GetReportRequestCountRequest extends AmaselMwsObject {
	...
	public GetReportRequestCountRequest(final String marketplace,
			final String merchant, final TypeList reportTypeList,
		...
		this(marketplace, merchant, reportTypeList, reportProcessingStatusList,
	 ...
	 * @return this instance
	 */
	public GetReportRequestCountRequest withReportProcessingStatusList(
			StatusList value) {
	 ...
	 * @return this instance
	 */
	public GetReportRequestCountRequest withRequestedFromDate(
	 ...
	 * @return this instance
	 */
	public GetReportRequestCountRequest withRequestedToDate(
			XMLGregorianCalendar value) {
