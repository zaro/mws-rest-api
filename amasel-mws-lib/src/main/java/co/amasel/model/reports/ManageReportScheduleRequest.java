...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "reportType",
		"schedule", "scheduleDate", "mwsAuthToken"})
@XmlRootElement(name = "ManageReportScheduleRequest")
public class ManageReportScheduleRequest extends AmaselMwsObject {
	...
	public ManageReportScheduleRequest(final String marketplace,
			final String merchant, final String reportType,
			final String schedule, final XMLGregorianCalendar scheduleDate) {
	 ...
	 * @return this instance
	 */
	public ManageReportScheduleRequest withScheduleDate(
