...
@XmlType(name = "ReportInfo", propOrder = {"reportId", "reportType",
		"reportRequestId", "availableDate", "acknowledged", "acknowledgedDate"})
public class ReportInfo extends AmaselMwsObject {
	 ...
	 * 
	 */
	public ReportInfo(final String reportId, final String reportType,
			final String reportRequestId,
			final XMLGregorianCalendar availableDate,
			final boolean acknowledged,
			final XMLGregorianCalendar acknowledgedDate) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		availableDate = reader
				.read("AvailableDate", XMLGregorianCalendar.class);
		acknowledged = reader.read("Acknowledged", boolean.class);
		acknowledgedDate = reader.read("AcknowledgedDate",
