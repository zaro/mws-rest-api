...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "reportIdList",
		"acknowledged", "mwsAuthToken"})
@XmlRootElement(name = "UpdateReportAcknowledgementsRequest")
public class UpdateReportAcknowledgementsRequest extends AmaselMwsObject {
	...
	public UpdateReportAcknowledgementsRequest(final String marketplace,
			final String merchant, final IdList reportIdList,
	...
	public UpdateReportAcknowledgementsRequest(final String marketplace,
			final String merchant, final IdList reportIdList,
			final Boolean acknowledged, final String mwsAuthToken) {
