...
@XmlType(name = "ReportSchedule", propOrder = {"reportType", "schedule",
		"scheduledDate"})
public class ReportSchedule extends AmaselMwsObject {
	 ...
	 * 
	 */
	public ReportSchedule(final String reportType, final String schedule,
			final XMLGregorianCalendar scheduledDate) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		scheduledDate = reader
				.read("ScheduledDate", XMLGregorianCalendar.class);
	}
