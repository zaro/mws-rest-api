...
@XmlType(name = "", propOrder = {"marketplace", "merchant",
		...
		"maxCount", "requestedFromDate", "requestedToDate", "mwsAuthToken"})
@XmlRootElement(name = "GetReportRequestListRequest")
public class GetReportRequestListRequest extends AmaselMwsObject {
	...
	public GetReportRequestListRequest(final String marketplace,
			final String merchant, final IdList reportRequestIdList,
		...
		this(marketplace, merchant, reportRequestIdList, reportTypeList,
				reportProcessingStatusList, maxCount, requestedFromDate,
	 ...
	 * @return this instance
	 */
	public GetReportRequestListRequest withReportProcessingStatusList(
			StatusList value) {
	 ...
	 * @return this instance
	 */
	public GetReportRequestListRequest withRequestedFromDate(
	 ...
	 * @return this instance
	 */
	public GetReportRequestListRequest withRequestedToDate(
			XMLGregorianCalendar value) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		reportProcessingStatusList = reader.read("ReportProcessingStatusList",
				StatusList.class);
		maxCount = reader.read("MaxCount", Integer.class);
		requestedFromDate = reader.read("RequestedFromDate",
				XMLGregorianCalendar.class);
		requestedToDate = reader.read("RequestedToDate",
				XMLGregorianCalendar.class);
