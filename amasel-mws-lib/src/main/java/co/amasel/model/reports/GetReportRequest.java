...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "reportId",
		"reportOutputStream", "mwsAuthToken"})
@XmlRootElement(name = "GetReportRequest")
public class GetReportRequest extends AmaselMwsObject {
	 ...
	 * 
	 */
	public GetReportRequest(final String marketplace, final String merchant,
			final String reportId) {
		this(marketplace, merchant, reportId, null);
	}

	public GetReportRequest(final String marketplace, final String merchant,
			final String reportId, final String mwsAuthToken) {
