...
@XmlType(name = "", propOrder = {"count", "reportInfo"})
@XmlRootElement(name = "UpdateReportAcknowledgementsResult")
public class UpdateReportAcknowledgementsResult extends AmaselMwsObject {
	 ...
	 * 
	 */
	public UpdateReportAcknowledgementsResult(final int count,
	 ...
	 * @return this instance
	 */
	public UpdateReportAcknowledgementsResult withReportInfoList(
			ReportInfo... values) {
