...
@XmlType(name = "", propOrder = {"count", "reportRequestInfo"})
@XmlRootElement(name = "CancelReportRequestsResult")
public class CancelReportRequestsResult extends AmaselMwsObject {
	 ...
	 * 
	 */
	public CancelReportRequestsResult(final int count,
			final List<ReportRequestInfo> reportRequestInfo) {
		this.count = count;
	 ...
	 * <CODE>set</CODE> method for the reportRequestInfo property.
	 * 
	 * <p>
	...
	public boolean isSetReportRequestInfoList() {
		return ((this.reportRequestInfo != null) && (!this.reportRequestInfo
				.isEmpty()));
	}
	 ...
	 * @return this instance
	 */
	public CancelReportRequestsResult withReportRequestInfo(
			ReportRequestInfo... values) {
	 ...
	 * 
	 */
	public void setReportRequestInfoList(
			List<ReportRequestInfo> reportRequestInfoList) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		reportRequestInfo = (List) reader.readList("ReportRequestInfo",
