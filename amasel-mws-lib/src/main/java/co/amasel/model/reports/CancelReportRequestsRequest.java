...
@XmlType(name = "", propOrder = {"marketplace", "merchant",
		...
		"requestedFromDate", "requestedToDate", "mwsAuthToken"})
@XmlRootElement(name = "CancelReportRequestsRequest")
public class CancelReportRequestsRequest extends AmaselMwsObject {
	...
	public CancelReportRequestsRequest(final String marketplace,
		...
		this(marketplace, merchant, reportRequestIdList, reportTypeList,
				reportProcessingStatusList, requestedFromDate, requestedToDate,
				null);
	}
	 ...
	 * @return this instance
	 */
	public CancelReportRequestsRequest withReportProcessingStatusList(
			StatusList value) {
	 ...
	 * @return this instance
	 */
	public CancelReportRequestsRequest withRequestedFromDate(
	 ...
	 * @return this instance
	 */
	public CancelReportRequestsRequest withRequestedToDate(
			XMLGregorianCalendar value) {
