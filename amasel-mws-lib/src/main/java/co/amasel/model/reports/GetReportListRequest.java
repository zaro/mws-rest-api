...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "maxCount",
		"reportTypeList", "acknowledged", "availableFromDate",
		"availableToDate", "reportRequestIdList", "mwsAuthToken"})
@XmlRootElement(name = "GetReportListRequest")
public class GetReportListRequest extends AmaselMwsObject {
	 ...
	 * 
	 */
	public GetReportListRequest(final String marketplace,
			final String merchant, final Integer maxCount,
			final TypeList reportTypeList, final Boolean acknowledged,
			final XMLGregorianCalendar availableFromDate,
			final XMLGregorianCalendar availableToDate,
			final IdList reportRequestIdList) {
		this(marketplace, merchant, maxCount, reportTypeList, acknowledged,
				availableFromDate, availableToDate, reportRequestIdList, null);
	}
	...
	public GetReportListRequest(final String marketplace,
			...
			final XMLGregorianCalendar availableFromDate,
			final XMLGregorianCalendar availableToDate,
			final IdList reportRequestIdList, final String mwsAuthToken) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		availableFromDate = reader.read("AvailableFromDate",
				XMLGregorianCalendar.class);
		availableToDate = reader.read("AvailableToDate",
				XMLGregorianCalendar.class);
