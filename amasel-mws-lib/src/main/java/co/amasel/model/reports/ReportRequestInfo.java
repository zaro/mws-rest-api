...
@XmlType(name = "ReportRequestInfo", propOrder = {"reportRequestId",
		"reportType", "startDate", "endDate", "scheduled", "submittedDate",
		"reportProcessingStatus", "generatedReportId", "startedProcessingDate",
		"completedDate"})
public class ReportRequestInfo extends AmaselMwsObject {
	...
	public ReportRequestInfo(final String reportRequestId,
			final String reportType, final XMLGregorianCalendar startDate,
			final XMLGregorianCalendar endDate, final boolean scheduled,
	...
	public void setStartedProcessingDate(
	...
	public ReportRequestInfo withStartedProcessingDate(
			XMLGregorianCalendar startedProcessingDate) {
	...
	public ReportRequestInfo withCompletedDate(
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		submittedDate = reader
				.read("SubmittedDate", XMLGregorianCalendar.class);
		reportProcessingStatus = reader.read("ReportProcessingStatus",
				String.class);
		generatedReportId = reader.read("GeneratedReportId", String.class);
		startedProcessingDate = reader.read("StartedProcessingDate",
				XMLGregorianCalendar.class);
		completedDate = reader
				.read("CompletedDate", XMLGregorianCalendar.class);
	}
