...
@XmlType(name = "", propOrder = {"requestReportResult", "responseMetadata"})
@XmlRootElement(name = "RequestReportResponse")
public class RequestReportResponse extends AmaselMwsObject {
	 ...
	 * 
	 */
	public RequestReportResponse(final RequestReportResult requestReportResult,
	 ...
	 * 
	 * @return possible object is {@link RequestReportResult }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link RequestReportResult }
	 * 
	 */
	 ...
	 */
	public RequestReportResponse withRequestReportResult(
			RequestReportResult value) {
	...
	public void readFragmentFrom(MwsReader reader) {
		requestReportResult = reader.read("RequestReportResult",
				RequestReportResult.class);
