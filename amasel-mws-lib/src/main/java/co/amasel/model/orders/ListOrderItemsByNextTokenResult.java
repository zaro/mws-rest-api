 ...
 * </pre>
 */
public class ListOrderItemsByNextTokenResult extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public ListOrderItemsByNextTokenResult withAmazonOrderId(
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Orders/2013-09-01",
				"ListOrderItemsByNextTokenResult", this);
	}

	/** Value constructor. */
	public ListOrderItemsByNextTokenResult(String nextToken,
			String amazonOrderId, List<OrderItem> orderItems) {
		this.nextToken = nextToken;
		this.amazonOrderId = amazonOrderId;
		this.orderItems = orderItems;
	}
