 ...
 * </pre>
 */
public class ListOrdersByNextTokenResult extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public ListOrdersByNextTokenResult withCreatedBefore(
	 ...
	 * @return This instance.
	 */
	public ListOrdersByNextTokenResult withLastUpdatedBefore(
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Orders/2013-09-01",
				"ListOrdersByNextTokenResult", this);
	}

	/** Value constructor. */
	public ListOrdersByNextTokenResult(String nextToken,
			XMLGregorianCalendar createdBefore,
			XMLGregorianCalendar lastUpdatedBefore, List<Order> orders) {
		this.nextToken = nextToken;
		this.createdBefore = createdBefore;
		this.lastUpdatedBefore = lastUpdatedBefore;
		this.orders = orders;
