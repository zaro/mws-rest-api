 ...
 * </pre>
 */
public class ListOrdersRequest extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public ListOrdersRequest withCreatedBefore(
	 ...
	 * @return This instance.
	 */
	public ListOrdersRequest withLastUpdatedAfter(
	 ...
	 * @return This instance.
	 */
	public ListOrdersRequest withLastUpdatedBefore(
	...
	public void readFragmentFrom(MwsReader r) {
		...
		lastUpdatedAfter = r.read("LastUpdatedAfter",
				XMLGregorianCalendar.class);
		lastUpdatedBefore = r.read("LastUpdatedBefore",
				XMLGregorianCalendar.class);
		orderStatus = r.readList("OrderStatus", "Status", String.class);
		marketplaceId = r.readList("MarketplaceId", "Id", String.class);
		fulfillmentChannel = r.readList("FulfillmentChannel", "Channel",
				String.class);
		...
		tfmShipmentStatus = r.readList("TFMShipmentStatus", "Status",
				String.class);
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Orders/2013-09-01",
				"ListOrdersRequest", this);
	}

	/** Value constructor. */
	public ListOrdersRequest(String sellerId, String mwsAuthToken,
			XMLGregorianCalendar createdAfter,
			XMLGregorianCalendar createdBefore,
			XMLGregorianCalendar lastUpdatedAfter,
			XMLGregorianCalendar lastUpdatedBefore, List<String> orderStatus,
			List<String> marketplaceId, List<String> fulfillmentChannel,
			List<String> paymentMethod, String buyerEmail,
			String sellerOrderId, Integer maxResultsPerPage,
	...
	public ListOrdersRequest(String sellerId,
			XMLGregorianCalendar createdAfter,
			XMLGregorianCalendar createdBefore,
			XMLGregorianCalendar lastUpdatedAfter,
			XMLGregorianCalendar lastUpdatedBefore, List<String> orderStatus,
