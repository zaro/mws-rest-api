 ...
 * </pre>
 */
public class ListOrdersResponse extends AmaselMwsObject {
	 ...
	 */
	public ListOrdersResponse withListOrdersResult(
	 ...
	 * @return This instance.
	 */
	public ListOrdersResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public ListOrdersResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Orders/2013-09-01",
				"ListOrdersResponse", this);
	}

	/** Value constructor. */
	public ListOrdersResponse(ListOrdersResult listOrdersResult,
			ResponseMetadata responseMetadata) {
		this.listOrdersResult = listOrdersResult;
		this.responseMetadata = responseMetadata;
	}
