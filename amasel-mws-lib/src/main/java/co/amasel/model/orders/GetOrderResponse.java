 ...
 * </pre>
 */
public class GetOrderResponse extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public GetOrderResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public GetOrderResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	/** Value constructor. */
	public GetOrderResponse(GetOrderResult getOrderResult,
			ResponseMetadata responseMetadata) {
		this.getOrderResult = getOrderResult;
		this.responseMetadata = responseMetadata;
	}
