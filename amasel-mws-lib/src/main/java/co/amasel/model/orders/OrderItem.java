 ...
 * </pre>
 */
public class OrderItem extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public OrderItem withScheduledDeliveryStartDate(
	 ...
	 * @return This instance.
	 */
	public OrderItem withScheduledDeliveryEndDate(
	 ...
	 *            The new value to set.
	 */
	public void setBuyerCustomizedInfo(
	 ...
	 * @return This instance.
	 */
	public OrderItem withBuyerCustomizedInfo(
			BuyerCustomizedInfoDetail buyerCustomizedInfo) {
		this.buyerCustomizedInfo = buyerCustomizedInfo;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		scheduledDeliveryStartDate = r.read("ScheduledDeliveryStartDate",
				String.class);
		scheduledDeliveryEndDate = r.read("ScheduledDeliveryEndDate",
				String.class);
		priceDesignation = r.read("PriceDesignation", String.class);
		buyerCustomizedInfo = r.read("BuyerCustomizedInfo",
				BuyerCustomizedInfoDetail.class);
	}
	...
	/** Value constructor. */
	public OrderItem(String asin, String sellerSKU, String orderItemId,
			String title, int quantityOrdered, Integer quantityShipped,
			PointsGrantedDetail pointsGranted, Money itemPrice,
			Money shippingPrice, Money giftWrapPrice, Money itemTax,
			Money shippingTax, Money giftWrapTax, Money shippingDiscount,
			Money promotionDiscount, List<String> promotionIds, Money codFee,
			Money codFeeDiscount, String giftMessageText, String giftWrapLevel,
			InvoiceData invoiceData, String conditionNote, String conditionId,
			String conditionSubtypeId, String scheduledDeliveryStartDate,
			String scheduledDeliveryEndDate, String priceDesignation,
			BuyerCustomizedInfoDetail buyerCustomizedInfo) {
		this.asin = asin;
		this.sellerSKU = sellerSKU;
		this.orderItemId = orderItemId;
