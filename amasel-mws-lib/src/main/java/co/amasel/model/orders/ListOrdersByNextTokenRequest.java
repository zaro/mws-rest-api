 ...
 * </pre>
 */
public class ListOrdersByNextTokenRequest extends AmaselMwsObject {
	...
	public void writeTo(MwsWriter w) {
		w.write("http://internal.amazon.com/coral/com.amazon.maws.coral/",
				"ListOrdersByNextTokenRequest", this);
	}

	/** Value constructor. */
	public ListOrdersByNextTokenRequest(String sellerId, String mwsAuthToken,
			String nextToken) {
		this.sellerId = sellerId;
		this.mwsAuthToken = mwsAuthToken;
		this.nextToken = nextToken;
