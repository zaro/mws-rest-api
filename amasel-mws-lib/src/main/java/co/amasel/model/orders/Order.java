 ...
 * </pre>
 */
public class Order extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setPaymentExecutionDetail(
	...
	public boolean isSetPaymentExecutionDetail() {
		return paymentExecutionDetail != null
				&& !paymentExecutionDetail.isEmpty();
	}
	 ...
	 * @return This instance.
	 */
	public Order withPaymentExecutionDetail(
			PaymentExecutionDetailItem... values) {
	 ...
	 * @return This instance.
	 */
	public Order withShipmentServiceLevelCategory(
			String shipmentServiceLevelCategory) {
		this.shipmentServiceLevelCategory = shipmentServiceLevelCategory;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public Order withCbaDisplayableShippingLabel(
			String cbaDisplayableShippingLabel) {
		this.cbaDisplayableShippingLabel = cbaDisplayableShippingLabel;
		return this;
	}
	 ...
	 *            The new value to set.
	 */
	public void setEarliestDeliveryDate(
	 ...
	 * @return This instance.
	 */
	public Order withEarliestDeliveryDate(
			XMLGregorianCalendar earliestDeliveryDate) {
		this.earliestDeliveryDate = earliestDeliveryDate;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		numberOfItemsUnshipped = r
				.read("NumberOfItemsUnshipped", Integer.class);
		paymentExecutionDetail = r.readList("PaymentExecutionDetail",
				"PaymentExecutionDetailItem", PaymentExecutionDetailItem.class);
		...
		shipmentServiceLevelCategory = r.read("ShipmentServiceLevelCategory",
				String.class);
		shippedByAmazonTFM = r.read("ShippedByAmazonTFM", Boolean.class);
		tfmShipmentStatus = r.read("TFMShipmentStatus", String.class);
		cbaDisplayableShippingLabel = r.read("CbaDisplayableShippingLabel",
				String.class);
		orderType = r.read("OrderType", String.class);
		earliestShipDate = r.read("EarliestShipDate",
				XMLGregorianCalendar.class);
		latestShipDate = r.read("LatestShipDate", XMLGregorianCalendar.class);
		earliestDeliveryDate = r.read("EarliestDeliveryDate",
				XMLGregorianCalendar.class);
		latestDeliveryDate = r.read("LatestDeliveryDate",
				XMLGregorianCalendar.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		...
		w.writeList("PaymentExecutionDetail", "PaymentExecutionDetailItem",
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Orders/2013-09-01", "Order",
				this);
	}

	/** Value constructor. */
	public Order(String amazonOrderId, String sellerOrderId,
			XMLGregorianCalendar purchaseDate,
			XMLGregorianCalendar lastUpdateDate, String orderStatus,
			String fulfillmentChannel, String salesChannel,
			String orderChannel, String shipServiceLevel,
			Address shippingAddress, Money orderTotal,
			Integer numberOfItemsShipped, Integer numberOfItemsUnshipped,
			List<PaymentExecutionDetailItem> paymentExecutionDetail,
			String paymentMethod, String marketplaceId, String buyerEmail,
			String buyerName, String shipmentServiceLevelCategory,
			Boolean shippedByAmazonTFM, String tfmShipmentStatus,
			String cbaDisplayableShippingLabel, String orderType,
			XMLGregorianCalendar earliestShipDate,
			XMLGregorianCalendar latestShipDate,
			XMLGregorianCalendar earliestDeliveryDate,
			XMLGregorianCalendar latestDeliveryDate, Boolean isBusinessOrder,
			String purchaseOrderNumber, Boolean isPrime, Boolean isPremiumOrder) {
		this.amazonOrderId = amazonOrderId;
		this.sellerOrderId = sellerOrderId;
		this.purchaseDate = purchaseDate;
		this.lastUpdateDate = lastUpdateDate;
	...
	public Order(String amazonOrderId, String sellerOrderId,
			...
			XMLGregorianCalendar earliestDeliveryDate,
			XMLGregorianCalendar latestDeliveryDate, Boolean isBusinessOrder,
			String purchaseOrderNumber, Boolean isPrime) {
		this.amazonOrderId = amazonOrderId;
		this.sellerOrderId = sellerOrderId;
		this.purchaseDate = purchaseDate;
		this.lastUpdateDate = lastUpdateDate;
