 ...
 * </pre>
 */
public class InvoiceData extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public InvoiceData withBuyerSelectedInvoiceCategory(
			String buyerSelectedInvoiceCategory) {
		this.buyerSelectedInvoiceCategory = buyerSelectedInvoiceCategory;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		buyerSelectedInvoiceCategory = r.read("BuyerSelectedInvoiceCategory",
				String.class);
	...
	/** Value constructor. */
	public InvoiceData(String invoiceRequirement,
			String buyerSelectedInvoiceCategory, String invoiceTitle,
