...
@XmlType(name = "ListMarketplaceParticipationsByNextTokenResponse", propOrder = {
		"listMarketplaceParticipationsByNextTokenResult", "responseMetadata"})
...
public class ListMarketplaceParticipationsByNextTokenResponse
	 ...
	 */
	public void setListMarketplaceParticipationsByNextTokenResult(
			ListMarketplaceParticipationsByNextTokenResult listMarketplaceParticipationsByNextTokenResult) {
	...
	/**
	 * Set the value of ListMarketplaceParticipationsByNextTokenResult, return
	 * this.
	 *
	 * @param listMarketplaceParticipationsByNextTokenResult
	 *            The new value to set.
	 ...
	 */
	public ListMarketplaceParticipationsByNextTokenResponse withListMarketplaceParticipationsByNextTokenResult(
			ListMarketplaceParticipationsByNextTokenResult listMarketplaceParticipationsByNextTokenResult) {
		this.listMarketplaceParticipationsByNextTokenResult = listMarketplaceParticipationsByNextTokenResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsByNextTokenResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsByNextTokenResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		listMarketplaceParticipationsByNextTokenResult = r.read(
				"ListMarketplaceParticipationsByNextTokenResult",
				ListMarketplaceParticipationsByNextTokenResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.write("ListMarketplaceParticipationsByNextTokenResult",
				listMarketplaceParticipationsByNextTokenResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Sellers/2011-07-01",
				"ListMarketplaceParticipationsByNextTokenResponse", this);
	}
