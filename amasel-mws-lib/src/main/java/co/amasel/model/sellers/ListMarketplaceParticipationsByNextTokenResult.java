...
@XmlType(name = "ListMarketplaceParticipationsByNextTokenResult", propOrder = {
		"nextToken", "listParticipations", "listMarketplaces"})
...
public class ListMarketplaceParticipationsByNextTokenResult
	 ...
	 */
	public ListMarketplaceParticipationsByNextTokenResult withNextToken(
			String nextToken) {
		this.nextToken = nextToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsByNextTokenResult withListParticipations(
			ListParticipations listParticipations) {
		this.listParticipations = listParticipations;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsByNextTokenResult withListMarketplaces(
	...
	public void readFragmentFrom(MwsReader r) {
		...
		listParticipations = r.read("ListParticipations",
				ListParticipations.class);
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Sellers/2011-07-01",
				"ListMarketplaceParticipationsByNextTokenResult", this);
	}

	/** Value constructor. */
	public ListMarketplaceParticipationsByNextTokenResult(String nextToken,
			ListParticipations listParticipations,
			ListMarketplaces listMarketplaces) {
		this.nextToken = nextToken;
		this.listParticipations = listParticipations;
