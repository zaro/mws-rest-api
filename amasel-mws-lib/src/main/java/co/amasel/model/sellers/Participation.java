...
@XmlType(name = "Participation", propOrder = {"marketplaceId", "sellerId",
		"hasSellerSuspendedListings"})
@XmlRootElement(name = "Participation")
public class Participation extends AmaselMwsObject {
	 ...
	 *            The new value to set.
	 */
	public void setHasSellerSuspendedListings(
			HasSellerSuspendedListingsEnum hasSellerSuspendedListings) {
	 ...
	 * @return This instance.
	 */
	public Participation withHasSellerSuspendedListings(
			HasSellerSuspendedListingsEnum hasSellerSuspendedListings) {
		this.hasSellerSuspendedListings = hasSellerSuspendedListings;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		...
		hasSellerSuspendedListings = r.read("HasSellerSuspendedListings",
				HasSellerSuspendedListingsEnum.class);
	}
	...
	/** Value constructor. */
	public Participation(String marketplaceId, String sellerId,
			HasSellerSuspendedListingsEnum hasSellerSuspendedListings) {
		this.marketplaceId = marketplaceId;
		this.sellerId = sellerId;
		this.hasSellerSuspendedListings = hasSellerSuspendedListings;
