...
@XmlType(name = "GetServiceStatusResult", propOrder = {"status", "timestamp",
		"messageId", "messages"})
...
public class GetServiceStatusResult extends AmaselMwsObject {
	...
	/** Value constructor. */
	public GetServiceStatusResult(ServiceStatusEnum status,
			XMLGregorianCalendar timestamp, String messageId,
