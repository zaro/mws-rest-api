...
public class ListMarketplaceParticipationsByNextTokenRequest
		extends
			AmaselMwsObject {
	 ...
	 */
	public ListMarketplaceParticipationsByNextTokenRequest withSellerId(
			String sellerId) {
		this.sellerId = sellerId;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsByNextTokenRequest withMWSAuthToken(
			String mwsAuthToken) {
		this.mwsAuthToken = mwsAuthToken;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsByNextTokenRequest withNextToken(
			String nextToken) {
		this.nextToken = nextToken;
		return this;
	}
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Sellers/2011-07-01",
				"ListMarketplaceParticipationsByNextTokenRequest", this);
	}

	/** Value constructor. */
	public ListMarketplaceParticipationsByNextTokenRequest(String sellerId,
