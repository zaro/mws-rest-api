...
@XmlType(name = "Marketplace", propOrder = {"marketplaceId", "name",
		"defaultCountryCode", "defaultCurrencyCode", "defaultLanguageCode",
		"domainName"})
@XmlRootElement(name = "Marketplace")
public class Marketplace extends AmaselMwsObject {
	...
	/** Value constructor. */
	public Marketplace(String marketplaceId, String name,
			String defaultCountryCode, String defaultCurrencyCode,
			String defaultLanguageCode, String domainName) {
		this.marketplaceId = marketplaceId;
		this.name = name;
		this.defaultCountryCode = defaultCountryCode;
		this.defaultCurrencyCode = defaultCurrencyCode;
