...
public class ListMarketplaceParticipationsResult extends AmaselMwsObject {
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsResult withListParticipations(
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsResult withListMarketplaces(
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Sellers/2011-07-01",
				"ListMarketplaceParticipationsResult", this);
	}

	/** Value constructor. */
	public ListMarketplaceParticipationsResult(String nextToken,
			ListParticipations listParticipations,
			ListMarketplaces listMarketplaces) {
		this.nextToken = nextToken;
		this.listParticipations = listParticipations;
