...
@XmlType(name = "ListMarketplaceParticipationsResponse", propOrder = {
		"listMarketplaceParticipationsResult", "responseMetadata"})
@XmlRootElement(name = "ListMarketplaceParticipationsResponse")
public class ListMarketplaceParticipationsResponse extends AmaselMwsObject {
	...
	public void setListMarketplaceParticipationsResult(
			ListMarketplaceParticipationsResult listMarketplaceParticipationsResult) {
	 ...
	 */
	public ListMarketplaceParticipationsResponse withListMarketplaceParticipationsResult(
			ListMarketplaceParticipationsResult listMarketplaceParticipationsResult) {
		this.listMarketplaceParticipationsResult = listMarketplaceParticipationsResult;
		return this;
	}
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsResponse withResponseMetadata(
	 ...
	 * @return This instance.
	 */
	public ListMarketplaceParticipationsResponse withResponseHeaderMetadata(
			ResponseHeaderMetadata responseHeaderMetadata) {
		this.responseHeaderMetadata = responseHeaderMetadata;
		return this;
	}
	...
	public void readFragmentFrom(MwsReader r) {
		listMarketplaceParticipationsResult = r.read(
				"ListMarketplaceParticipationsResult",
				ListMarketplaceParticipationsResult.class);
	...
	public void writeFragmentTo(MwsWriter w) {
		w.write("ListMarketplaceParticipationsResult",
				listMarketplaceParticipationsResult);
	...
	public void writeTo(MwsWriter w) {
		w.write("https://mws.amazonservices.com/Sellers/2011-07-01",
				"ListMarketplaceParticipationsResponse", this);
	}
