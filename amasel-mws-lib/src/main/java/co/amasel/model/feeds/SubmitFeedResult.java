...
@XmlType(name = "", propOrder = {"feedSubmissionInfo"})
@XmlRootElement(name = "SubmitFeedResult")
public class SubmitFeedResult extends AmaselMwsObject {
	 ...
	 * 
	 * @return possible object is {@link FeedSubmissionInfo }
	 * 
	 */
	...
	public void readFragmentFrom(MwsReader reader) {
		feedSubmissionInfo = reader.read("FeedSubmissionInfo",
