...
@XmlType(name = "", propOrder = {"marketplace", "merchant",
...
public class GetFeedSubmissionListRequest extends AmaselMwsObject {
	...
	public GetFeedSubmissionListRequest(final String marketplace,
			final String merchant, final IdList feedSubmissionIdList,
			final Integer maxCount, final TypeList feedTypeList,
		...
		this(marketplace, merchant, feedSubmissionIdList, maxCount,
				feedTypeList, feedProcessingStatusList, submittedFromDate,
	 ...
	 * 
	 * @return possible object is {@link TypeList }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link TypeList }
	 * 
	 */
	 ...
	 * @return this instance
	 */
	public GetFeedSubmissionListRequest withFeedProcessingStatusList(
			StatusList value) {
	 ...
	 * @return this instance
	 */
	public GetFeedSubmissionListRequest withSubmittedFromDate(
	 ...
	 * @return this instance
	 */
	public GetFeedSubmissionListRequest withSubmittedToDate(
			XMLGregorianCalendar value) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		feedSubmissionIdList = reader
				.read("FeedSubmissionIdList", IdList.class);
		maxCount = reader.read("MaxCount", Integer.class);
		feedTypeList = reader.read("FeedTypeList", TypeList.class);
		feedProcessingStatusList = reader.read("FeedProcessingStatusList",
				StatusList.class);
		submittedFromDate = reader.read("SubmittedFromDate",
				XMLGregorianCalendar.class);
		submittedToDate = reader.read("SubmittedToDate",
				XMLGregorianCalendar.class);
