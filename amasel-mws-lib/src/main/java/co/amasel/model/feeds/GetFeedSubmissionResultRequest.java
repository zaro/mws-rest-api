...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "feedSubmissionId",
		"feedSubmissionResultOutputStream", "mwsAuthToken"})
@XmlRootElement(name = "GetFeedSubmissionResultRequest")
public class GetFeedSubmissionResultRequest extends AmaselMwsObject {
	...
	public GetFeedSubmissionResultRequest(final String marketplace,
			final String merchant, final String feedSubmissionId) {
	...
	public void setFeedSubmissionResultOutputStream(
			OutputStream feedSubmissionResultOutputStream) {
