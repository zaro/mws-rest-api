...
@XmlType(name = "", propOrder = {"submitFeedResult", "responseMetadata"})
@XmlRootElement(name = "SubmitFeedResponse")
public class SubmitFeedResponse extends AmaselMwsObject {
	 ...
	 * 
	 */
	public SubmitFeedResponse(final SubmitFeedResult submitFeedResult,
	 ...
	 * 
	 * @return possible object is {@link SubmitFeedResult }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link SubmitFeedResult }
	 * 
	 */
	...
	public void readFragmentFrom(MwsReader reader) {
		submitFeedResult = reader.read("SubmitFeedResult",
				SubmitFeedResult.class);
