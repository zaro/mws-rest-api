...
@XmlType(name = "FeedSubmissionInfo", propOrder = {"feedSubmissionId",
		"feedType", "submittedDate", "feedProcessingStatus",
		"startedProcessingDate", "completedProcessingDate"})
public class FeedSubmissionInfo extends AmaselMwsObject {
	 ...
	 * 
	 */
	public FeedSubmissionInfo(final String feedSubmissionId,
			final String feedType, final String submittedDate,
			final String feedProcessingStatus,
			final XMLGregorianCalendar startedProcessingDate,
			final XMLGregorianCalendar completedProcessingDate) {
	 ...
	 * @return this instance
	 */
	public FeedSubmissionInfo withStartedProcessingDate(
	 ...
	 * @return this instance
	 */
	public FeedSubmissionInfo withCompletedProcessingDate(
			XMLGregorianCalendar value) {
	...
	public void readFragmentFrom(MwsReader reader) {
		...
		feedProcessingStatus = reader
				.read("FeedProcessingStatus", String.class);
		startedProcessingDate = reader.read("StartedProcessingDate",
				XMLGregorianCalendar.class);
		completedProcessingDate = reader.read("CompletedProcessingDate",
				XMLGregorianCalendar.class);
	}
