...
@XmlType(name = "", propOrder = {"marketplace", "merchant",
		"feedSubmissionIdList", "feedTypeList", "submittedFromDate",
		"submittedToDate", "mwsAuthToken"})
@XmlRootElement(name = "CancelFeedSubmissionsRequest")
public class CancelFeedSubmissionsRequest extends AmaselMwsObject {
	...
	public CancelFeedSubmissionsRequest(final String marketplace,
		...
		this(marketplace, merchant, feedSubmissionIdList, feedTypeList,
	 ...
	 * @return this instance
	 */
	public CancelFeedSubmissionsRequest withSubmittedFromDate(
	 ...
	 * @return this instance
	 */
	public CancelFeedSubmissionsRequest withSubmittedToDate(
			XMLGregorianCalendar value) {
