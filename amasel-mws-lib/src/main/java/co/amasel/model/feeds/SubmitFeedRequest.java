...
/**
 * Generated by AWS Code Generator, but contains hand additions for streaming
 * and Content-MD5 support
 * <p/>
 * Tue Feb 03 16:00:09 PST 2009
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "", propOrder = {"marketplace", "marketplaceIdList",
		"merchant", "feedContent", "contentMD5", "feedType", "purgeAndReplace",
		"mwsAuthToken"})
@XmlRootElement(name = "SubmitFeedRequest")
public class SubmitFeedRequest extends AmaselMwsObject {
	 ...
	 * 
	 */
	public SubmitFeedRequest(final String marketplace,
			final IdList marketplaceIdList, final String merchant,
			final InputStream feedContent, final String contentMD5,
			final String feedType, final Boolean purgeAndReplace) {
		this(marketplace, merchant, feedContent, contentMD5, feedType,
				purgeAndReplace, null);
	}
	...
	public SubmitFeedRequest(final String marketplace, final String merchant,
			final InputStream feedContent, final String contentMD5,
			final String feedType, final Boolean purgeAndReplace) {
		this(marketplace, merchant, feedContent, contentMD5, feedType,
				purgeAndReplace, null);
	...
	public SubmitFeedRequest(final String marketplace,
		...
		this(marketplace, marketplaceIdList, merchant, feedContent, contentMD5,
				feedType, purgeAndReplace);
	...
	public SubmitFeedRequest(final String marketplace,
		...
		this(marketplace, marketplaceIdList, merchant, feedContent, contentMD5,
				feedType, purgeAndReplace, mwsAuthToken);
		setContentType(contentType);
	}
	 ...
	 *             in here for backwards compatibility. Use
	 *             {@link #setMarketplaceIdList(IdList)} instead.
	 * @param value
