...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "feedTypeList",
		"feedProcessingStatusList", "submittedFromDate", "submittedToDate",
		"mwsAuthToken"})
@XmlRootElement(name = "GetFeedSubmissionCountRequest")
public class GetFeedSubmissionCountRequest extends AmaselMwsObject {
	...
	public GetFeedSubmissionCountRequest(final String marketplace,
			final String merchant, final TypeList feedTypeList,
		...
		this(marketplace, merchant, feedTypeList, feedProcessingStatusList,
	 ...
	 * @return this instance
	 */
	public GetFeedSubmissionCountRequest withFeedProcessingStatusList(
			StatusList value) {
	 ...
	 * @return this instance
	 */
	public GetFeedSubmissionCountRequest withSubmittedFromDate(
	 ...
	 * @return this instance
	 */
	public GetFeedSubmissionCountRequest withSubmittedToDate(
			XMLGregorianCalendar value) {
