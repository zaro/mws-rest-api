...
@XmlType(name = "", propOrder = {"marketplace", "merchant", "nextToken",
		"mwsAuthToken"})
@XmlRootElement(name = "GetFeedSubmissionListByNextTokenRequest")
public class GetFeedSubmissionListByNextTokenRequest extends AmaselMwsObject {
	...
	public GetFeedSubmissionListByNextTokenRequest(final String marketplace,
			final String merchant, final String nextToken) {
