...
public class GetOrder {
    ...
    public GetOrder(AmaselClientBase client) {
        this.client = client;
    }
    
    public Future<MwsApiResponse> invoke(GetOrderRequest request) throws AmaselClientException {
        return client.invoke(MethodMap.GetOrder, request);
    }
}
