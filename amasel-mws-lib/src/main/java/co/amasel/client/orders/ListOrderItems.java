...
public class ListOrderItems {
    ...
    public ListOrderItems(AmaselClientBase client) {
        this.client = client;
    }
    
    public Future<MwsApiResponse> invoke(ListOrderItemsRequest request) throws AmaselClientException {
        return client.invoke(MethodMap.ListOrderItems, request);
    }
}
