...
public class GetReportScheduleCountResult extends com.amazonaws.mws.model.GetReportScheduleCountResult implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            count = reader.read("Count", Integer.class);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportScheduleCountResult",this);
    }
