...
public class GetReportResponse extends com.amazonaws.mws.model.GetReportResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportResult = reader.read("GetReportResult", GetReportResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetReportResult", getReportResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportResponse",this);
    }
