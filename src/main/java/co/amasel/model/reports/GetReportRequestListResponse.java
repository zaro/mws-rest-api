...
public class GetReportRequestListResponse extends com.amazonaws.mws.model.GetReportRequestListResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportRequestListResult = reader.read("GetReportRequestListResult", GetReportRequestListResult.class);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportRequestListResponse",this);
    }
