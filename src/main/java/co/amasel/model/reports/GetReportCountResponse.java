...
public class GetReportCountResponse extends com.amazonaws.mws.model.GetReportCountResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportCountResult = reader.read("GetReportCountResult", GetReportCountResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetReportCountResult", getReportCountResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportCountResponse",this);
    }
