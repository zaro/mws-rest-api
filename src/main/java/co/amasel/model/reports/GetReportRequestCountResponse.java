...
public class GetReportRequestCountResponse extends com.amazonaws.mws.model.GetReportRequestCountResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportRequestCountResult = reader.read("GetReportRequestCountResult", GetReportRequestCountResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetReportRequestCountResult", getReportRequestCountResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportRequestCountResponse",this);
    }
