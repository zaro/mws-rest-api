...
public class StatusList extends com.amazonaws.mws.model.StatusList implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            status = (List)reader.readList("Status", String.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.writeList("Status", status);
       
    }

    public void writeTo(MwsWriter w){
        w.write("XML_NS", "StatusList",this);
    }
