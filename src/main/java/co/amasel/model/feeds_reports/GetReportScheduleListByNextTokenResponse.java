...
public class GetReportScheduleListByNextTokenResponse extends com.amazonaws.mws.model.GetReportScheduleListByNextTokenResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportScheduleListByNextTokenResult = reader.read("GetReportScheduleListByNextTokenResult", GetReportScheduleListByNextTokenResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetReportScheduleListByNextTokenResult", getReportScheduleListByNextTokenResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportScheduleListByNextTokenResponse",this);
    }
