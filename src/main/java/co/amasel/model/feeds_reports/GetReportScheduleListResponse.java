...
public class GetReportScheduleListResponse extends com.amazonaws.mws.model.GetReportScheduleListResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportScheduleListResult = reader.read("GetReportScheduleListResult", GetReportScheduleListResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetReportScheduleListResult", getReportScheduleListResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportScheduleListResponse",this);
    }
