...
public class GetReportRequestListByNextTokenResponse extends com.amazonaws.mws.model.GetReportRequestListByNextTokenResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getReportRequestListByNextTokenResult = reader.read("GetReportRequestListByNextTokenResult", GetReportRequestListByNextTokenResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetReportRequestListByNextTokenResult", getReportRequestListByNextTokenResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetReportRequestListByNextTokenResponse",this);
    }
