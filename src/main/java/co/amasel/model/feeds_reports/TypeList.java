...
public class TypeList extends com.amazonaws.mws.model.TypeList implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            type = (List)reader.readList("Type", String.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.writeList("Type", type);
       
    }

    public void writeTo(MwsWriter w){
        w.write("XML_NS", "TypeList",this);
    }
