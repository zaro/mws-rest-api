...
public class CancelReportRequestsResponse extends com.amazonaws.mws.model.CancelReportRequestsResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            cancelReportRequestsResult = reader.read("CancelReportRequestsResult", CancelReportRequestsResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("CancelReportRequestsResult", cancelReportRequestsResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "CancelReportRequestsResponse",this);
    }
