...
public class UpdateReportAcknowledgementsResponse extends com.amazonaws.mws.model.UpdateReportAcknowledgementsResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            updateReportAcknowledgementsResult = reader.read("UpdateReportAcknowledgementsResult", UpdateReportAcknowledgementsResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("UpdateReportAcknowledgementsResult", updateReportAcknowledgementsResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "UpdateReportAcknowledgementsResponse",this);
    }
