...
public class GetFeedSubmissionListResponse extends com.amazonaws.mws.model.GetFeedSubmissionListResponse implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            getFeedSubmissionListResult = reader.read("GetFeedSubmissionListResult", GetFeedSubmissionListResult.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.write("GetFeedSubmissionListResult", getFeedSubmissionListResult);
    ...
    public void writeTo(MwsWriter w){
        w.write("XML_NS", "GetFeedSubmissionListResponse",this);
    }
