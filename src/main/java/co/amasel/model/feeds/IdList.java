...
public class IdList extends com.amazonaws.mws.model.IdList implements AmaselMwsObject {
    public void readFragmentFrom(MwsReader reader){

            id = (List)reader.readList("Id", String.class);
    ...
    public void writeFragmentTo(MwsWriter writer){
            ...
            writer.writeList("Id", id);
       
    }

    public void writeTo(MwsWriter w){
        w.write("XML_NS", "IdList",this);
    }
