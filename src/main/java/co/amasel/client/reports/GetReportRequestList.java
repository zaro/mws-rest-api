...
public class GetReportRequestList extends AmaselClient {
    ...
    public GetReportRequestList(Vertx vertx, String endPoint, AmazonCredentials credentials) {
        super(vertx);
        this.endPoint = endPoint;
        this.credentials = credentials;
    }
    public Future<MwsApiResponse> invoke(GetReportRequestListRequest request) throws ApiRequestException {
