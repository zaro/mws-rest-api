...
public class GetReportCount extends AmaselClient {
    ...
    public GetReportCount(Vertx vertx, String endPoint, AmazonCredentials credentials) {
        super(vertx);
        this.endPoint = endPoint;
        this.credentials = credentials;
    }
    public Future<MwsApiResponse> invoke(GetReportCountRequest request) throws ApiRequestException {
