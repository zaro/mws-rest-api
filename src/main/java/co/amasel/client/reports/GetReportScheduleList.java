...
public class GetReportScheduleList extends AmaselClient {
    ...
    public GetReportScheduleList(Vertx vertx, String endPoint, AmazonCredentials credentials) {
        super(vertx);
        this.endPoint = endPoint;
        this.credentials = credentials;
    }
    public Future<MwsApiResponse> invoke(GetReportScheduleListRequest request) throws ApiRequestException {
