...
public class CancelFeedSubmissions extends AmaselClient {
    ...
    public CancelFeedSubmissions(Vertx vertx, String endPoint, AmazonCredentials credentials) {
        super(vertx);
        this.endPoint = endPoint;
        this.credentials = credentials;
    }
    public Future<MwsApiResponse> invoke(CancelFeedSubmissionsRequest request) throws ApiRequestException {
