...
public class GetMatchingProduct extends AmaselClient {
    ...
    public GetMatchingProduct(Vertx vertx, String endPoint, AmazonCredentials credentials) {
        super(vertx);
        this.endPoint = endPoint;
        this.credentials = credentials;
    }
    public Future<MwsApiResponse> invoke(GetMatchingProductRequest request) throws ApiRequestException {
