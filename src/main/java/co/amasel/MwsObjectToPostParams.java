...
import co.amasel.model.products.GetCompetitivePricingForSKURequest;
import co.amasel.model.products.SellerSKUListType;
...
public class MwsObjectToPostParams implements MwsWriter {
    ...
    public static void main(String[] args){
        ...
        p.write("xml_ns", "GetCompetitivePricingForSKURequest", req);
